...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div>
            <ej:DropDownList ID="DropDownList1" runat="server" ShowCheckbox="true" OnCheckedChange="dropdownlist_CheckedChange" OnCascade="dropdownlist_Cascade" OnSearch="dropdownlist_Search">
            <Items>
