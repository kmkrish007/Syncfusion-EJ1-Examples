...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <ej:Autocomplete ID="Autocomplete1" runat="server"  DataTextField="Description" DataUniqueKeyField="Product_ID" Width="100%" ShowPopupButton="true" ClientSideOnSelect="onSelect">
