...
var ejTooltip = (function (_super) {
    ...
    ejTooltip.prototype._render = function () {
        this.tooltip = ej.buildTag("div.e-tooltip-wrap e-widget", "", {}, { role: "tooltip", 'aria-hidden': 'true', 'aria-describedby': this.id + '_content', 'id': this.id + '_Main' });
        ...
        if (this._isHidden) {
            ...
            if ($(this.tooltip).css("display") == 'none' && this.model.enabled == true) {
                ...
                if ($(this.tooltip).css("display") == 'block') {
                    ...
                    if (!zIndex || zIndex < 10000) zIndex = 10000;
                    else zIndex += 1;
    ...
    ejTooltip.prototype._getScrollableParents = function () {
        var elements = $(this.element).parentsUntil("html").filter(function () {
