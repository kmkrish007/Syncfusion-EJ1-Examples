(function ($, ej, undefined) {
    ...
    ej.widget("ejGanttChart", "ej.GanttChart", {
        ...
        setViewPortHeight: function () {
            this._viewportHeight = this._getViewportHeight() - 18;
        },
        ...
        _init: function () {
          ...
          //  Inner div for scroller
            ...
            if (proxy._$bodyContent.width() < proxy._$bodyContainerParent.width())
            {
                isBorderBox = true;
		        proxy._viewportHeight = proxy._getViewportHeight() - 18;
            }
            else
            {
                isBorderBox = false;
            ...
            proxy._$bodyContainer.ejScroller({
                ...
                height: !isBorderBox ? proxy._getViewportHeight() : proxy._getViewportHeight() - 18,
...
//                    proxy._completeAction(args);
        ...
        _updateTooltipPosition: function (tooltip, posx, posy, isEditingTooltip) {
            if (tooltip && tooltip.length > 0) {
                ...
                if (isEditingTooltip || ((posy + tooltip.height() + 30) > topEnd)) {
					...
					if (isEditingTooltip && pos + tooltip.height() + rowHeight > posy) 
						pos = posy + rowHeight / 2;
        ...
        _tooltipDuration: function (data) {
            ...
            if (data.ttipduration != null && data.ttipduration != undefined)
                val += this._removeSeparator(parseFloat(data.ttipduration.toFixed(2))) + " ";
        ...
        updateHeight: function (height) {
            ...
            if (parseInt(proxy._$bodyContainer.css("height")) != proxy._viewportHeight) {
                var height = (proxy._$bodyContent.width() < proxy._$bodyContainerParent.width()) ? (proxy._viewportHeight + 18) : proxy._viewportHeight;
                proxy._$bodyContainer.css("height", height);
            }
        },
            ...
            for (var i = 0; i < count; i++) {
                ...
                for (var j = 0; j < nonWorkingRange.length; j++) {
                    var backColor = nonWorkingRange[j].isWorking ? nonWorkingRange[j].color : model.highlightNonWorkingTime ? model.nonWorkingBackground : null,
                        ...
                        width = ((nonWorkingRange[j].to/3600) - (nonWorkingRange[j].from/3600)) * model.perHourWidth; //Converting seconds to hour 
