    ...
    ej.widget("ejPivotChart", "ej.PivotChart", {
            ...
            if (!isOlapServerMode) {
                ...
                if (this.model.enableMultiLevelLabels && this.model.analysisMode == ej.PivotChart.AnalysisMode.Pivot && this.model.operationalMode == ej.PivotChart.OperationalMode.ServerMode) {
                    ...
                    if (pivotEngine[0] != undefined) {
                        ...
                        if ($(this.element).parents(".e-pivotclient").length > 0) {
                            if (!ej.isNullOrUndefined(pivotEngine.d[0])) {
                                var keyString = pivotEngine.d[0].Key;
                                tempEngine["JsonRecords"] = (keyString == "JsonRecords") ? pivotEngine.d[0].Value : [];
                            }
                        }
                        else {
                            tempEngine["JsonRecords"] = {};
            ...
            try {
                if (msg[0] != undefined) {
                    ...
                    if (!ej.isNullOrUndefined(msg[2])) {
                        keyString = msg[2].Key;
                        if (keyString == "AnalysisMode" && msg[2].Value == "Olap")
                            this.model.analysisMode = ej.PivotChart.AnalysisMode.Olap;
                    }
                    if (!ej.isNullOrUndefined(this._pivotClientObj)) {
                        if (this.model.analysisMode == ej.Pivot.AnalysisMode.Pivot)
                        ...
                        if (msg[2] != null && msg[2] != undefined) {
                            keyString = msg[2].Key;
                            if (keyString == "ClientReports")
                                this._pivotClientObj.reports = msg[2].Value;
                        }
                        if (msg[3]) {
                            keyString = msg[3].Key;
                            if (keyString == "Title" && msg.d[3].Value != "")
                    ...
                    if (msg[2] != null && msg[2] != undefined) {
                        keyString = msg[2].Key;
                        if (!keyString == "ClientReports" && keyString != "AnalysisMode")
                    ...
                    if (this._pagerObj != null && $(".e-pivotpager")[0] != null && $(".e-pivotpager")[0] != undefined) {
                        ...
                        if (msg.d[3] != null && msg.d[3] != undefined) {
                            keyString = msg.d[3].Key;
                            if (keyString == "PageSettings")
                    ...
                    if(this.model.operationalMode == ej.PivotChart.OperationalMode.ServerMode) {                        
                        ...
                        if (this.model.dataSource.values[0].measures.length == 1)
                            if (!ej.isNullOrUndefined(this.model.dataSource.values[0].measures[0].format))
                                this.model.primaryYAxis.labelFormat = (this.model.primaryYAxis.labelFormat != null || this.model.primaryYAxis.labelFormat != "") && (this.model.primaryYAxis.labelFormat) ? this.model.primaryYAxis.labelFormat : (this.model.dataSource.values[0].measures[0].format.toLowerCase() == "decimal") ? "n2" : (this.model.dataSource.values[0].measures[0].format.toLowerCase() == "number") ? "n" : (this.model.dataSource.values[0].measures[0].format.toLowerCase() == "percent") ? "p2" : (this.model.dataSource.values[0].measures[0].format.toLowerCase() == "currency") ? "c" : (this.model.dataSource.values[0].measures[0].format.toLowerCase() == "date") ? "MM/dd/yyyy" : (this.model.dataSource.values[0].measures[0].format.toLowerCase() == "time") ? "hh:mm:ss" : "";
                    }
                    ...
                    if (this.model.operationalMode == ej.PivotChart.OperationalMode.ClientMode) {
                        if (this.model.dataSource.values.length == 1)
                            if (!ej.isNullOrUndefined(this.model.dataSource.values[0].format))
                                this.model.primaryYAxis.labelFormat = (this.model.primaryYAxis.labelFormat != null || this.model.primaryYAxis.labelFormat != "") && (this.model.primaryYAxis.labelFormat) ? this.model.primaryYAxis.labelFormat : (this.model.dataSource.values[0].format.toLowerCase() == "decimal") ? "n2" : (this.model.dataSource.values[0].format.toLowerCase() == "number") ? "n" : (this.model.dataSource.values[0].format.toLowerCase() == "percentage") ? "p2" : (this.model.dataSource.values[0].format.toLowerCase() == "currency") ? "c" : (this.model.dataSource.values[0].format.toLowerCase() == "date") ? (!ej.isNullOrUndefined(this.model.dataSource.values[0].formatString) ? this.model.dataSource.values[0].formatString : "dd/MMMM/yyyy") : (this.model.dataSource.values[0].format.toLowerCase() == "time") ? "hh:mm:ss" : "";
                    }
                    else {
                        ...
                        if (jsonData.labelFormat.length == 1 && pivotCalculations.length == 1)
                            this.model.primaryYAxis.labelFormat = (this.model.primaryYAxis.labelFormat != null || this.model.primaryYAxis.labelFormat != "") && (this.model.primaryYAxis.labelFormat) ? this.model.primaryYAxis.labelFormat : (jsonData.labelFormat[0].toLowerCase() == "#.##") ? "n2" : (jsonData.labelFormat[0].toLowerCase() == "###") ? "n" : (jsonData.labelFormat[0].toLowerCase() == "p") ? "p2" : (jsonData.labelFormat[0].toLowerCase() == "c") ? "c" : "";
                    }
        ...
        exportPivotChart: function (exportOption, fileName, exportFormat) {
            ...
            if (!ej.isNullOrUndefined(exportFormat) && exportFormat.toLowerCase() == "excel")
                exportSetting = { url: "", fileName: "PivotChart", exportMode: ej.PivotChart.ExportMode.ClientMode, title: "", description: "", exportType: exportOption, controlName: this, exportChartAsImage: true, titleAlignment: "center" };
            else
                exportSetting = { url: "", fileName: "PivotChart", exportMode: ej.PivotChart.ExportMode.ClientMode, title: "", description: "", exportType: exportOption, controlName: this, titleAlignment: "center"  };
