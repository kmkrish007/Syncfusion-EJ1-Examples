    ...
    ej.widget("ejPivotGrid", "ej.PivotGrid", {
        ...
        _wireEvents: function () {
            ...
            this._on(this.element, "mouseover", ".value,.rowheader,.colheader,.summary", ej.proxy(function (evt) {
                if (!$(evt.target).hasClass("cellValue") && !$(evt.target).children().hasClass("cellValue")) {
                    ...
                    if (!ej.isNullOrUndefined(val.text()) &&  $.trim(val.text()) != "") {
            ...
            this._on(this.element, "mouseover", ".e-pivotButton", ej.proxy(function (evt) {
                if (this._isDragging) {
                    ...
                    if (evt.target.className.indexOf("e-pivotButton") >= 0)
                        this.element.find(".e-dropIndicator").css("top", evt.target.getBoundingClientRect().top - 20).css("left", evt.target.getBoundingClientRect().left - 3);
                    else
                        this.element.find(".e-dropIndicator").css("top", evt.target.parentElement.getBoundingClientRect().top - 20).css("left", evt.target.parentElement.getBoundingClientRect().left - 3);
                }
            }, this));
        ...
        _keyUpPress:function(e){
            ...
            if (e.which === 13 && this.model.enableCellEditing && !this.model.enableCellSelection && $("#" + this._id).find(".value.e-hoverCell").length) {
                ...
                this._startCellPosition = $($("#" + this._id).find(".value.e-hoverCell")).attr("data-p");
        ...
        _keyDownPress: function (e) {
            ...
            if (e.shiftKey) {
                if (ej.isNullOrUndefined(this._startPosCell)) {
                    this._startCellPosition = e.target.getAttribute("data-p");
            ...
            if ((e.which === 40 || e.which === 39 || e.which === 38 || e.which === 37) && e.shiftKey && this.model.enableCellSelection) {
                ...
                if (Number(this._startCellPosition.split(",")[0]) <= Number(this._curFocus.selection.attr("data-p").split(",")[0]) && Number(this._startCellPosition.split(",")[1]) <= Number(this._curFocus.selection.attr("data-p").split(",")[1])) {
                    for (i = Number(this._startCellPosition.split(",")[0]) ; i <= Number(this._curFocus.selection.attr("data-p").split(",")[0]) ; i++) {
                        for (j = Number(this._startCellPosition.split(",")[1]) ; j <= Number(this._curFocus.selection.attr("data-p").split(",")[1]) ; j++) {
                ...
                else if (Number(this._startCellPosition.split(",")[0]) >= Number(this._curFocus.selection.attr("data-p").split(",")[0]) && Number(this._startCellPosition.split(",")[1]) >= Number(this._curFocus.selection.attr("data-p").split(",")[1])) {
                    for (i = Number(this._startCellPosition.split(",")[0]) ; i >= Number(this._curFocus.selection.attr("data-p").split(",")[0]) ; i--) {
                        for (j = Number(this._startCellPosition.split(",")[1]) ; j >= Number(this._curFocus.selection.attr("data-p").split(",")[1]) ; j--) {
                            if ($("#" + this._id).find("[data-p='" + i + "," + j + "']").hasClass("value")) {
                                $("#" + this._id).find("[data-p='" + i + "," + j + "']").addClass("e-hoverCell");
        ...
        _endColResizing: function (e) {
                           ...
                           if (cell.length) {
                               ...
                               if (this.model.analysisMode == ej.Pivot.AnalysisMode.Pivot) {
                                   if ((this.element.find(".e-pivotGridTable").find("[role='columnheader']").find(".e-expand").length > 1 || this.element.find(".e-pivotGridTable").find("[role='columnheader']").find(".e-collapse").length > 1)) {
                                       if (isFrozenHeader)
                                           pos = parseInt(this.element.find(".pivotGridFrozenTable thead tr:last").find("[data-p^='" + cell.attr("data-p").split(",")[0] + "']").index());
                                       else if (this.model.enableAdvancedFilter) {
                                           var count = 0;
                                           for (var j = 0; j < parseInt(cell.attr("data-p").split(",")[0]); j++) {
                                               if (this.element.find(".e-pivotGridTable thead tr:last th:eq(" + j + ")").css("display") == "none")
                                                   count++;
                                           }
                                           pos = parseInt(cell.attr("data-p").split(",")[0]) - (count + (this.layout().toLowerCase() == ej.PivotGrid.Layout.ExcelLikeLayout ? (this._JSONRecords[0].ColSpan - 1) : 0));
           ...
           if (this.model.enableGroupingBar) {
               ...
               this.element.find(".groupingBarPivot").css({ "overflow": "hidden" });
           }
            ...
            if ((!this.model.frozenHeaderSettings.enableFrozenHeaders && !this.model.frozenHeaderSettings.enableFrozenColumnHeaders && !this.model.frozenHeaderSettings.enableFrozenRowHeaders) && !ej.isNullOrUndefined(this._JSONRecords)) {
              ...
              if (this.model.operationalMode == ej.Pivot.OperationalMode.ClientMode && !ej.isNullOrUndefined(this.model.dataSource.columns) && (this.model.dataSource.columns.length == 0 || this.model.dataSource.columns.length == 1) || this.model.operationalMode == ej.Pivot.OperationalMode.ServerMode && !ej.isNullOrUndefined(JSON.parse(this.getOlapReport()).PivotColumns) && (JSON.parse(this.getOlapReport()).PivotColumns.length == 0 || JSON.parse(this.getOlapReport()).PivotColumns.length==1)) {
                    ...
                    for (var i = 0; i < (this._JSONRecords.length / this._rowCount) ; i++) {
                        if (ej.isNullOrUndefined(this.element.find(".e-pivotGridTable tbody tr:first").children(":visible")[i]))
                            break;
                        var col = "<col style='width:" + this.element.find(".e-pivotGridTable tbody tr:first").children(":visible")[i].offsetWidth / Number($(this.element.find(".e-pivotGridTable tbody tr:first").children(":visible")[i]).attr("colspan")) + "px'></col>";
                        colgroup.append(col);
                    }
                }
                if (this.model.enableAdvancedFilter)
        ...
        _createDialog: function (title, treeViewData) {
            ...
            for (var i = 0; i < this._editorTreeData.length; i++) {
                if (this._editorTreeData[i].name == null || !this._editorTreeData[i].name.toString().replace(/^\s+|\s+$/gm, '')) { this._editorTreeData[i].name = "(blank)"; this._editorTreeData[i].id = "(blank)"; }
                if (!ej.isNullOrUndefined(this._editorTreeData[i].id) && typeof (this._editorTreeData[i].id) == "string") { this._editorTreeData[i].id = this._editorTreeData[i].id.replace(/ /g, "_"); }
            }
            ...
            if (this.model.enableMemberEditorSorting) {
                ...
                if (this.model.enableRTL)
                    this.element.find(".memberSortDiv, .e-insideDiv").addClass("e-rtl");
            }
        ...
        _nodeCheckChanges: function (args) {
            if (this._onDemandNodeExpand) {
                ...
                if (isUnChecked) {
                ...
                else if (((!ej.isNullOrUndefined(args.model.id) && args.model.id.toLowerCase() == "allelement") || (!ej.isNullOrUndefined(args.id) && (args.id.toLowerCase() == "(all)_0" || args.id.toLowerCase() != "all"))) && (this.model.enableMemberEditorPaging || this._editorTreeData)) {
                    if (args.type == "nodeUncheck") {
                        ...
                        if (!ej.isNullOrUndefined(temp) && temp.length == 0) {
                            ...
                            this.element.find(".e-checkAllBox").find("span.e-chk-image").removeClass("e-checkmark").addClass("e-chk-inact");
                        }
                        else {
            ...
            if (this.model.operationalMode == ej.Pivot.OperationalMode.ClientMode) {
                ...
                if (this.model.analysisMode == ej.Pivot.AnalysisMode.Olap) {
                    ...
                    filteredData = $.map(this._currentReportItems, function (obj, index) {
                        ...
                        if (!ej.isNullOrUndefined(obj["filterItems"])) {
        ...
        _applyToolTip: function (e) {
            if (this.model.enableToolTip) {
                ...
                if ($(targetCell).find("input").length == 0 && !$(targetCell).hasClass("curInput") && !ej.isNullOrUndefined($(targetCell).attr("role"))) {
                    ...
                    var tdPos = !ej.isNullOrUndefined(this._pivotClientObj)? $(targetCell).position(): targetCell.getBoundingClientRect();
                    ...
                    if (!ej.isNullOrUndefined(this._pivotClientObj)) {
                        ...
                        var tdContainer = $(e.target).hasClass("cellValue") ? e.target.parentElement : e.target;;
                        var scale = tdContainer.getBoundingClientRect().width / tdContainer.offsetWidth;
                        if (scale > 1) {
                            topPos = ($(tdContainer).position().top / scale);
                            topPos = (($(this.element).height()) - (topPos * scale)) < (100 * scale) ? ((topPos) - ($("#" + this._id + "_gridTooltip").outerHeight())) : topPos + 40;
                            //leftPos = $(tdContainer).position().left / scale;
                            //containerEndPos = ($("#" + this._id).parent().position().left / scale) + ($("#" + this._id).parent().width());
                            //tooltipEndPos = leftPos + ($("#" + this._id + "_gridTooltip").outerWidth());
                            //leftPos = ((leftPos > 0 ? leftPos : 0) + (((containerEndPos - tooltipEndPos)) < 0 ? (((containerEndPos - tooltipEndPos)) - 20) : 5));
                        }
                    }
                    if (!ej.isNullOrUndefined(this._pivotClientObj) && this._pivotClientObj.model.enableRTL)
                        leftPos = $("#" + this._pivotClientObj._id + "_PivotGrid").parent().hasClass("e-maximumView") ? tdPos.left : (leftPos - ($("#" + this._pivotClientObj._id + "_PivotGrid").position().left + this._pivotClientObj.element.find(".e-gridContainer").scrollLeft()));
        ...
        _applyVScrolling: function () {
            ...
            if (pGridObj._seriesPageCount > 1) {
                var getMinVerticalPos = function () { return isClientWithResponsive ? (Math.round(ctrlObj.element.find(".e-vScrollPanel").offset().top) + 1) : (Math.round(ctrlObj.element.find(".e-vScrollPanel").offset().top) + 1); };
                var vScrollBar = $(ctrlObj.element).find(".e-vScrollPanel");
                vScrollBar.height(!isPivotClient ? $(oGridDiv).height() : (this._pivotClientObj.model.isResponsive ? parseInt(this._pivotClientObj.element.find(".e-controlPanel").height()) :(this._pivotClientObj.controlPlacement() == "tile" ? parseInt(this._pivotClientObj.element.find(".e-gridContainer").parents("table:eq(0)").height()) : parseInt(this._pivotClientObj.element.find(".e-gridContainer").height()))));
            ...
            if (pGridObj._categPageCount > 1) {
                var getMinHorizontalPos = function () { return isClientWithResponsive ? (Math.round(ctrlObj.element.find(".e-hScrollPanel").offset().left) + 1) : (Math.round(ctrlObj.element.find(".e-hScrollPanel").offset().left) + 1); };
        ...
        _drillDown: function (e) {
            ...
            if (!this.model.enableDeferUpdate) {
                ...
                if (this.model.operationalMode == ej.Pivot.OperationalMode.ClientMode || this.model.analysisMode == ej.Pivot.AnalysisMode.Pivot) {
                    ...
                    var pGridTb = (this.model.operationalMode == ej.PivotGrid.OperationalMode.ServerMode && (this.model.enableAdvancedFilter || (($(this.element).parents(".e-pivotclient").length > 0 || $(this.element).parents(".e-fullScreenView").length > 0) && this._pivotClientObj.model.enableAdvancedFilter))) ? $(this.element).find(".e-pivotGridTable").detach() : this._table;
                    ...
                    if (!this.model.enablePaging && !this.model.enableVirtualScrolling) {
                        ...
                        if (this.model.operationalMode == ej.PivotGrid.OperationalMode.ServerMode && (this.model.enableAdvancedFilter || (($(this.element).parents(".e-pivotclient").length > 0 || $(this.element).parents(".e-fullScreenView").length > 0) && this._pivotClientObj.model.enableAdvancedFilter))) {
        ...
        _initCellSelection: function (e) {
            ...
            var targetCell;
            this._oriX = e.pageX, this._oriY = e.pageY;
            ...
            this._startCellPosition = $(targetCell)[0].attributes.getNamedItem("data-p").value;
            if (this._excelLikeJSONRecords != null && this.layout().toLowerCase() == ej.PivotGrid.Layout.ExcelLikeLayout) {
                ...
                this._startCellPosition = this.getJSONRecords()[((parseInt($(targetCell)[0].attributes.getNamedItem("data-p").value.split(',')[0])) * this._rowCount + parseInt(startIndex.split(',')[1]))].Index;
            }
        ...
        _headerClickCellSelection: function (e) {
            ...
            if (target != null) {
                ...
                this._startCellPosition = _headerType == "columnheader" ? $("#" + this._id + " [data-p^='" + (0 + parseInt(_position)) + ",']" + ".value").eq(0).attr("data-p") : $("#" + this._id + " [data-p$='," + (0 + parseInt(_position)) + "']" + ".value").eq(0).attr("data-p");
                if (this._excelLikeJSONRecords != null && this.layout().toLowerCase() == ej.PivotGrid.Layout.ExcelLikeLayout && !(this.model.analysisMode == ej.Pivot.AnalysisMode.Olap && this.model.operationalMode == ej.PivotGrid.OperationalMode.ServerMode))
                    this._startCellPosition = _headerType == "columnheader" ? $("#" + this._id + " [data-p^='" + (0 + parseInt(_position)) + ",']" + ".value:not(.summary)").eq(0).attr("data-p") : $("#" + this._id + " [data-p$='," + (0 + parseInt(_position)) + "']" + ".value:not(.summary)").eq(0).attr("data-p");
        ...
        _cellSelection: function (e) {
            ...
            var width = e.pageX - this.element.offset().left - (this._oriX - this.element.offset().left);
            var height = e.pageY - this.element.offset().top - (this._oriY - this.element.offset().top);
            var posX = this._oriX - this.element.offset().left;
            var posY = this._oriY - this.element.offset().top + 3;
            if (width < 0) {
            ...
            if (e.pageX < this._oriX) {
                $("#" + this._id + "_cellSelection").css({ left: (isPivotClient) ? posX : (e.pageX + 2), width: (isPivotClient) ? width : (this._oriX - e.pageX) });
            }
            else {
                $("#" + this._id + "_cellSelection").css({ left: (isPivotClient) ? posX : (this._oriX - 6), width: (isPivotClient) ? width : (e.pageX - this._oriX) });
            }
            if (e.pageY < this._oriY) {
                $("#" + this._id + "_cellSelection").css({ top: (isPivotClient) ? posY : e.pageY, height: (isPivotClient) ? height : (this._oriY - e.pageY - 7) });
            }
            else {
                $("#" + this._id + "_cellSelection").css({ top: (isPivotClient) ? posY : (this._oriY + 7), height: (isPivotClient) ? height : (e.pageY - this._oriY - 11) });
            }
        ...
        _completeCellSelection: function (e) {
            ...
            var count = 0;
            for (var rowSelCnt = (parseInt(this._startCellPosition.split(",")[1]) < parseInt(endPosCell.split(",")[1]) ? parseInt(this._startCellPosition.split(",")[1]) : parseInt(endPosCell.split(",")[1])) ; rowSelCnt <= (parseInt(this._startCellPosition.split(",")[1]) > parseInt(endPosCell.split(",")[1]) ? parseInt(this._startCellPosition.split(",")[1]) : parseInt(endPosCell.split(",")[1])) ; rowSelCnt++) {
                if (this.model.analysisMode == ej.Pivot.AnalysisMode.Olap || $("#" + this._id).find("td[data-p*='," + rowSelCnt + "']").parent().is(":visible")) {
                    for (var colSelCnt = (parseInt(this._startCellPosition.split(",")[0]) < parseInt(endPosCell.split(",")[0]) ? parseInt(this._startCellPosition.split(",")[0]) : parseInt(endPosCell.split(",")[0])) ; colSelCnt <= (parseInt(this._startCellPosition.split(",")[0]) > parseInt(endPosCell.split(",")[0]) ? parseInt(this._startCellPosition.split(",")[0]) : parseInt(endPosCell.split(",")[0])) ; colSelCnt++) {
            ...
            if (measureRowCount == 0)
                ...
                var measureCount = (this.model.operationalMode == ej.PivotGrid.OperationalMode.ServerMode) ? (JSON.parse(this.getOlapReport()).PivotCalculations.length) : (this.model.dataSource.values.length);
            var args = { JSONRecords: cellInfo, rowHeader: rowHeader, columnHeader: colHeader, measureCount: (measureRowCount > 0 ? ("Row:" + measureRowCount) : ("Column:" + measureColCount)) }
            if (!ej.isNullOrUndefined(this._pivotClientObj))
        ...
        exportPivotGrid: function (exportOption, fileName) {
            this._rowCount = !ej.isNullOrUndefined(this._rowLength) ? this._rowLength : this._rowCount;
            this._isExporting = true;            
            var exportSetting ={};
            if (exportOption.toLowerCase() == "excel" || exportOption.toLowerCase() == "excelexport")
                exportSetting = { url: "", fileName: "PivotGrid", exportMode: ej.PivotGrid.ExportMode.JSON, fileFormat: this.model.operationalMode == ej.PivotGrid.OperationalMode.ServerMode ? ".xls" : ".xlsx", title: "", description: "", exportType: exportOption, controlName: this, exportWithStyle: true, exportValueAsNumber: false, titleAlignment: "center" };
            else
                exportSetting = { url: "", fileName: "PivotGrid", exportMode: ej.PivotGrid.ExportMode.JSON, fileFormat: exportOption.toLowerCase() == "word" ? ".docx" : ".pdf", title: "", description: "", exportType: exportOption, controlName: this, exportWithStyle: true, titleAlignment: "center" };
            ...
            if (this.model.operationalMode == ej.PivotGrid.OperationalMode.ClientMode || exportSetting.exportMode == ej.PivotGrid.ExportMode.JSON) {
                ...
                if (this.model.enableCompleteDataExport && (this.model.enablePaging || this.model.enableVirtualScrolling)) {
                    ...
                    var lastcolumnIndex, columncount, rowdata, columndata, count = 0, isRowSubTotalEnabled = false, isColumnSubTotalEnabled = false,row = 0,rowcount = 0;
                    var isOlapClientmode = this.model.operationalMode == ej.PivotGrid.OperationalMode.ClientMode && this.model.analysisMode == ej.Pivot.AnalysisMode.Olap;
                    var isNOlapClientmode = this.model.operationalMode == ej.PivotGrid.OperationalMode.ClientMode && this.model.analysisMode != ej.Pivot.AnalysisMode.Olap;
                    var isServermode = this.model.operationalMode == ej.PivotGrid.OperationalMode.ServerMode;
                    var _exportRecords = $.extend(true, [], this.exportRecords);
                    var isOlapserver = (this.model.analysisMode == ej.Pivot.AnalysisMode.Olap && this.model.operationalMode == ej.PivotGrid.OperationalMode.ServerMode && (JSON.parse(this.getOlapReport()).PivotRows.length > 1))
                    if (!this.model.enableColumnGrandTotal || !this.model.enableGrandTotal || !this.model.enableRowGrandTotal) {
                        if ((!this.model.enableColumnGrandTotal || !this.model.enableGrandTotal)) {
                            if(!isOlapClientmode || isServermode){
                                for (var index = 0; index < _exportRecords.length; index++) {
                                    if ((_exportRecords[index].CSS == "summary cgtot") || (_exportRecords[index].CSS == "summary gtot" && _exportRecords[index].Index.split(',')[1] == 0)) {
                                        _exportRecords.splice(index);
                                    }
                                }
                            }
                            if (isOlapClientmode) {
                                for (var index = 0; index < _exportRecords.length; index++) {
                                    if (_exportRecords[index].Index.split(',')[1] == 0 && _exportRecords[index].CSS == "summary col") {
                                        _exportRecords.splice(index);
                                    }
                                }
                            }
                    ...
                    if ((this.model.analysisMode == ej.Pivot.AnalysisMode.Pivot || this.model.operationalMode == ej.PivotGrid.OperationalMode.ClientMode) && (!this.model.enableRowGrandTotal || !this.model.enableGrandTotal) && !isOlapserver) {
                        var total = this._rowCount - 1;
                            for (var index = 0; index < _exportRecords.length; index++) {
                                if (_exportRecords[index].Index.split(',')[1] == total)
                                    _exportRecords = _exportRecords.slice(0, index).concat(_exportRecords.slice(index + 1, _exportRecords.length))
                            }
                        rowcount = this._rowCount - 1;
                    }
                    if (this.model.analysisMode == ej.Pivot.AnalysisMode.Olap && this.model.operationalMode == ej.PivotGrid.OperationalMode.ServerMode && (JSON.parse(this.getOlapReport()).PivotRows.length > 1 || JSON.parse(this.getOlapReport()).PivotColumns.length > 1)) {
                        if (!this.model.enableColumnGrandTotal || !this.model.enableGrandTotal) {
                            for (var index = 0; index < _exportRecords.length; index++) {
                                if (_exportRecords[index].Index.split(',')[1] == 0 && _exportRecords[index].CSS == "summary") {
                                    _exportRecords.splice(index);
                                }
                            }
                        }
                        if (!this.model.enableRowGrandTotal || !this.model.enableGrandTotal) {
                            columncount = this.exportRecords.length / this._rowCount;
                            for (var index = 0; index < _exportRecords.length; index++) {
                                if (_exportRecords[index].Index.split(',')[0] == 0 && _exportRecords[index].CSS == "summary") {
                                    var column = index;
                                    var difference = this._rowCount - column;
                                    for (var idx = 0; idx < _exportRecords.length; idx++) {
                                        _exportRecords = _exportRecords.slice(0, column).slice(0, this._rowCount + row).concat(_exportRecords.slice(this._rowCount + count, _exportRecords.length));
                                        row = column - 1;
                                        column = column + this.element.find("tr").length - difference;
                                        count = row + 1;
                                    }
                                    break;
                                }
                        ...
                        rowcount = difference != undefined ? this.element.find("tr").length - difference : this.element.find("tr").length;
                    }
                    if (this.model.analysisMode == ej.Pivot.AnalysisMode.Pivot) {
                        if (isNOlapClientmode) {
                            rowdata = this.model.dataSource.rows;
                            columndata = this.model.dataSource.columns;
                        }
                        else {
                            if (this.getOlapReport() != null) {
                                rowdata = JSON.parse(this.getOlapReport()).PivotRows;
                                columndata = JSON.parse(this.getOlapReport()).PivotColumns;
                            }
                        }
                        if (rowcount == 0)
                            rowcount = this._rowCount;
                        columncount = _exportRecords.length / rowcount;
                        if (rowdata.length > 1 && this.layout() != "excellikelayout") {
                            for (var i = 0; i < rowdata.length; i++) {
                                if (rowdata[i].showSubTotal == false) {
                                    isRowSubTotalEnabled = true;
                                    for (var index = 0; index < _exportRecords.length; index++) {
                                        if (_exportRecords[index].Index.split(',')[0] == i && _exportRecords[index].CSS == "summary rstot" || _exportRecords[index].CSS == "summary stot") {
                                                var rowindex = _exportRecords[index].Index.split(',')[1];
                                                for (var idx = 0; idx < _exportRecords.length; idx++) {
                                                    if (_exportRecords[idx].Index.split(',')[1] == rowindex) {
                                                        _exportRecords = _exportRecords.slice(0, idx).concat(_exportRecords.slice(idx + 1, _exportRecords.length));
                                                        index = 0
                                                    }
                                                }
                                            }
                        ...
                        if (rowdata.length > 1 && isRowSubTotalEnabled == true) {
                            rowcount = _exportRecords.length / columncount;
                            columncount = _exportRecords.length / rowcount;
                            for (var i = 0; i < columncount - 1; i++) {
                                for (var idx = (_exportRecords[0].RowSpan) ; idx < _exportRecords.length; idx++) {
                                    if (_exportRecords[idx].Index.split(',')[0] == i && (_exportRecords[idx].CSS == "rowheader" || _exportRecords[idx].CSS == "summary rstot" || _exportRecords[idx].CSS == "summary stot" || _exportRecords[idx].CSS == "none")) {
                                        if (_exportRecords[idx].Expander == 1) {
                                            var rowIndex = _exportRecords[idx].Index.split(',')[1];
                                            var colIndex = _exportRecords[idx].Index.split(',')[0];
                                            var rowSpan = 0;
                                            for (j = 0; j < _exportRecords[idx].RowSpan ; j++) {
                                                if (((parseInt(rowIndex) + _exportRecords[idx].RowSpan) > _exportRecords[idx + j].Index.split(',')[1]) && colIndex == _exportRecords[idx + j].Index.split(',')[0]) {
                                                    rowSpan++;
                                                }
                                            }
                                            _exportRecords[idx].RowSpan = rowSpan;
                                        }
                                    }
                                }
                            }
                        }
                        if (columndata.length > 1 && this.layout() != "excellikelayout") {
                            if (isNOlapClientmode)
                                valuedata = this.model.dataSource.values;
                            if (isServermode)
                                valuedata = JSON.parse(this.getOlapReport()).PivotCalculations;
                            for (var i = 0; i < columndata.length; i++) {
                                if (columndata[i].showSubTotal == false) {
                                    isColumnSubTotalEnabled = true;
                                    for (var index = 0; index < _exportRecords.length; index++) {
                                        if (_exportRecords[index].Index.split(',')[1] == i && _exportRecords[index].CSS == "summary cstot" || _exportRecords[index].CSS == "summary stot") {
                                                _exportRecords = _exportRecords.slice(0, index - i).slice(0, index + (rowcount * valuedata.length) - i).concat(_exportRecords.slice(index + (rowcount * valuedata.length) - i, _exportRecords.length));
                                            }
                                        }
                                    }
                                }
                            }
                        if (columndata.length > 1 && isColumnSubTotalEnabled == true) {
                            columncount = _exportRecords.length / rowcount;
                            for (var i = 0; i < _exportRecords.length; i++) {
                                for (var idx = (_exportRecords[0].ColSpan) ; idx < _exportRecords.length; idx++) {
                                    if (_exportRecords[idx].Index.split(',')[0] == i && (_exportRecords[idx].CSS == "colheader" || _exportRecords[idx].CSS == "summary cstot" || _exportRecords[idx].CSS == "summary stot" || _exportRecords[idx].CSS == "none")) {
                                        if (_exportRecords[idx].Expander == 1) {
                                            var rowIndex = _exportRecords[idx].Index.split(',')[1];
                                            var colIndex = _exportRecords[idx].Index.split(',')[0];
                                            var colSpan = 0;
                                            for (j = 0; j < _exportRecords.length ; j++) {
                                                if (idx + j < _exportRecords.length && ((parseInt(colIndex) + _exportRecords[idx].ColSpan) > _exportRecords[idx + j].Index.split(',')[0]) && rowIndex == _exportRecords[idx + j].Index.split(',')[1]) {
                                                        colSpan++;
                                                        j += rowcount - 1;
                                                }
                                            }
                                            _exportRecords[idx].ColSpan = colSpan;
                                        }
                                    }
                                }
                            }
                    ...
                    var Json_length;
                    Json_length = _exportRecords.length;
                    if (rowcount != 0) {
                        if (!isOlapserver)
                            params = { args: JSON.stringify({ "pGridData": (_exportRecords != null && _exportRecords != "") ? _exportRecords : null, "rowCount": rowcount, "columnCount": (Json_length / rowcount), "fileFormat": (exportSetting.fileFormat + ((exportSetting.fileFormat == ".xls" || exportSetting.fileFormat == ".xlsx") ? ("~" + exportSetting.exportValueAsNumber) : "")), "fileName": ej.isNullOrUndefined(fileName) ? (ej.isNullOrUndefined(exportSetting.fileName) ? "PivotGrid" : exportSetting.fileName) : fileName, "colorSettings": colorDetails, "Formatting": this._cFormat, title: exportSetting.title, description: exportSetting.description, "language": this.model.locale, exportWithStyle: exportSetting.exportWithStyle, customObject: JSON.stringify(this.model.customObject), titleAlignment: exportSetting.titleAlignment }) };
                        else
                            params = { args: JSON.stringify({ "pGridData": (_exportRecords != null && _exportRecords != "") ? _exportRecords : null, "rowCount": rowcount, "columnCount": JSON.parse(this.getOlapReport()).PivotRows.length > 1 && !this.model.enableGrandTotal ? Json_length / rowcount : !this.model.enableColumnGrandTotal ? Json_length / rowcount : !ej.isNullOrUndefined(columncount) ? columncount : Json_length / rowcount, "fileFormat": (exportSetting.fileFormat + ((exportSetting.fileFormat == ".xls" || exportSetting.fileFormat == ".xlsx") ? ("~" + exportSetting.exportValueAsNumber) : "")), "fileName": ej.isNullOrUndefined(fileName) ? (ej.isNullOrUndefined(exportSetting.fileName) ? "PivotGrid" : exportSetting.fileName) : fileName, "colorSettings": colorDetails, "Formatting": this._cFormat, title: exportSetting.title, description: exportSetting.description, "language": this.model.locale, exportWithStyle: exportSetting.exportWithStyle, customObject: JSON.stringify(this.model.customObject), titleAlignment: exportSetting.titleAlignment }) };
                    }
                    else
                        params = { args: JSON.stringify({ "pGridData": (this.exportRecords != null && this.exportRecords != "") ? this.exportRecords : null, "rowCount": this._excelLikeJSONRecords != null ? this._excelRowCount : this._rowCount, "columnCount": this._excelLikeJSONRecords != null ? Math.floor(this._excelLikeJSONRecords.length / this._excelRowCount) : this.getJSONRecords() != null && !ej.isNullOrUndefined(this._rowLength) ? Json_length / this._rowLength : Math.floor(this.getJSONRecords().length / this._rowCount), "fileFormat": (exportSetting.fileFormat + ((exportSetting.fileFormat == ".xls" || exportSetting.fileFormat == ".xlsx") ? ("~" + exportSetting.exportValueAsNumber) : "")), "fileName": ej.isNullOrUndefined(fileName) ? (ej.isNullOrUndefined(exportSetting.fileName) ? "PivotGrid" : exportSetting.fileName) : fileName, "colorSettings": colorDetails, "Formatting": this._cFormat, title: exportSetting.title, description: exportSetting.description, "language": this.model.locale, exportWithStyle: exportSetting.exportWithStyle, customObject: JSON.stringify(this.model.customObject), titleAlignment: exportSetting.titleAlignment }) };
                }
                ...
                var params = {
                    args: JSON.stringify({
                        ...
                        titleAlignment: exportSetting.titleAlignment
                    })
                };
        ...
        _createCalculatedField: function () {
            ...
            var dialogTitle = this._getLocalizedLabels("CalculatedField");
            ...
            var addBtn = ej.buildTag("button#" + this._id + "_btnAdd", this._getLocalizedLabels("Add"), {}, { name: this._getLocalizedLabels("Add") })[0].outerHTML;
            ...
            var deleteBtn = ej.buildTag("button#" + this._id + "_btnDelete", this._getLocalizedLabels("Delete"), { "margin-top": "-2px" }, { name: this._getLocalizedLabels("Delete") })[0].outerHTML;
            ...
            var dialogFooter = ej.buildTag("div", okBtn + cancelBtn, { "float": this.model.enableRTL ? "left" : "right", "margin-bottom": "15px", "margin-top": "4px" })[0].outerHTML;
            ...
            var ejDialog = ej.buildTag("div#clientDialog.e-clientDialog", dialogContent + dialogFooter + calculatorDiv, { "opacity": "1" }).attr("title", dialogTitle)[0].outerHTML;
            $(ejDialog).appendTo("#" + this._id);
            ...
            if (this.model.pivotEnginePopulated != null)
                this._trigger("pivotEnginePopulated", { JSONRecords: jsonObj });
            ...
            $("#" + this._id + "_btnOk").click(function (evt) {
                ...
                else
                {
                    ...
                    var serializedCustomObject = JSON.stringify(pGridObj.model.customObject);
                    var eventArgs = JSON.stringify({ "action": "calculatedField", "headerTag": JSON.stringify(pGridObj._calculatedField), "currentReport": report, "valueSorting": JSON.stringify(pGridObj.model.valueSortSettings), "customObject": serializedCustomObject });
                    if (!pGridObj.model.enableDeferUpdate)
        ...
        openConditionalFormattingDialog: function () {
            ...
            var targetID = $(this.element).parents(".e-pivotclient").length >0 ? (this.element).parents(".e-pivotclient")[0].id :  this._id;
            $("#" + this._id + "_clientDlg").ejDialog({ width: "auto", target: "#" + targetID, enableResize: false, enableRTL: this.model.enableRTL, close: ej.proxy(ej.Pivot.closePreventPanel, this) });
            $(".e-titlebar").prepend(ej.buildTag("div", dialogTitle, { "display": "inline" })[0].outerHTML)[0];
            ...
            $("#" + this._id + "_fontcolor").ejColorPicker({
                enableRTL: this.model.enableRTL,
            });
            $("#" + this._id + "_backcolor").ejColorPicker({
                enableRTL: this.model.enableRTL,
            });
            $("#" + this._id + "_bordercolor").ejColorPicker({
                enableRTL: this.model.enableRTL,
            });
            ...
            $("#" + this._id + "_conType").ejDropDownList("option", "change", ej.proxy(this._activeConditionChange, this));
            $("#" + this._id + "_editCon").ejDropDownList("option", "change", ej.proxy(this._editConditionChange, this));
            ...
            this.ddlFontColor = $("#" + this._id + "_fontcolor").data("ejColorPicker");
            this.ddlBackColor = $("#" + this._id + "_backcolor").data("ejColorPicker");
            this.ddlBorderColor = $("#" + this._id + "_bordercolor").data("ejColorPicker");
            ...
            $("#" + this._id + "_OKBtn").click(function () {
                ...
                var ctrlObj = $(this).parents(".e-pivotclient").length > 0 ? $(this).parents(".e-pivotclient").data("ejPivotClient") : pGridObj;
                if ($("#" + pGridObj._id + '_editConText').val() == '') {
                    ej.Pivot._createErrorDialog(pGridObj._getLocalizedLabels("EnterFormatName"), pGridObj._getLocalizedLabels("Warning"), ctrlObj);
                }
                    ...
                    ej.Pivot._createErrorDialog(pGridObj._getLocalizedLabels("DuplicateFormatName"), pGridObj._getLocalizedLabels("Warning"), ctrlObj);
                }
                else if ($("#" + pGridObj._id + '_conFrom').val() == '') {
                    ej.Pivot._createErrorDialog(pGridObj._getLocalizedLabels("EnterOperand1"), pGridObj._getLocalizedLabels("Warning"), ctrlObj);
                }
                else if (!($("#" + pGridObj._id + "_conTo").attr("disabled")) && $("#" + pGridObj._id + '_conTo').val() == '') {
                    ej.Pivot._createErrorDialog(pGridObj._getLocalizedLabels("EnterOperand2"), pGridObj._getLocalizedLabels("Warning"), ctrlObj);
                }
                else if ($("#" + pGridObj._id + "_fValue").attr("disabled") && $("#" + pGridObj._id + '_fValue').val() == 'No Measure') {
                    ej.Pivot._createErrorDialog(pGridObj._getLocalizedLabels("NoMeasure"), pGridObj._getLocalizedLabels("Warning"), ctrlObj);
                }
                else {
            ...
            $("#" + this._id + "_removeBtn").click(function () {
                ...
                if (condition == true){
                    ...
                    if ($(this).parents(".e-pivotclient").length > 0) {
                        $(this).parents(".e-pivotclient").find(".e-dialog, .clientDialog").remove();
                    }
                    else
            ...
            $("#" + this._id + "_CancelBtn").click(function () {
                ...
                if ($(this).parents(".e-pivotclient").length > 0) {
                    pGridObj = $(this).parents(".e-pivotclient").find(".e-pivotgrid").data("ejPivotGrid");
                    $(this).parents(".e-pivotclient").find(".e-dialog, .e-clientDialog").remove();
                }
                else
                    pGridObj = $(this).parents(".e-pivotgrid").data("ejPivotGrid");
                pGridObj.element.find(".e-dialog, .e-clientDialog").remove();
        ...
        _editConditionChange: function () {
            if (this.ddlEditCondition._selectedIndices[0] > 0) {
                ...
                $("#" + this._id + "_fontcolor").ejColorPicker({ value: array[2] });
                $("#" + this._id + "_backcolor").ejColorPicker({ value: array[3] });
                $("#" + this._id + "_bordercolor").ejColorPicker({ value: array[4] });
        ...
        _removeCellFormatting: function (index, flag) {
            ...
            for (var j = 0; j < this._cFormat.length && index; j++) { 
                ...
                for (var i = 0; i < this._JSONRecords.length; i++) {
                    this._JSONRecords[i].CSS = this._JSONRecords[i].CSS.replace(" " + this._cFormat[j].split(",")[0].replace(/ /g, ""), "");
                }
            }
            if (flag) {
        ...
        _applyStyle: function(axis,jsonValue,mValue,val,fv1,fv2,condition,i,format){
            ...
            if (this._getResult(Number(fv1), Number(fv2), num, condition) && !ej.isNullOrUndefined(num) && $.isNumeric(num) && isValue && jsonValue.CSS.indexOf("value") != -1) {
        ...
        _refreshCellFormatting: function (jsonObj) {
            ...
            for (var j = 0; j < this._cFormat.length; j++) {
                ...
                for (var i = 0; i < jsonObj.length; i++) {
                    if (jsonObj[i].CSS.indexOf(array[0].replace(/ /g, "")) === -1) {
                        this._applyStyle(axis, jsonObj[i], array[11], val, array[9], array[10], array[1], i, this._cFormat[j].split(",")[0].replace(/ /g, ""));
                    }
                }
            }
            return jsonObj;
        ...
        _createDynamicRule: function (fontcolor, bgcolor, borderstyle, borderwidth, bordercolor, fontsize, fontstyle, name) {
            ...
            sheet.insertRule("." + name.replace(/ /g, "") + "{" + str + "}", 0);
        },

        _getMDXAxis: function () {
            var axis = "";
            for (var i = 0; i < this._JSONRecords.length; i++) {
                if (!ej.isNullOrUndefined(this._JSONRecords[i].Info) && this._JSONRecords[i].Info.toLowerCase().indexOf("measures") > -1) {
                    axis = this._JSONRecords[i].CSS.indexOf("colheader") > -1 ? "columns" : this._JSONRecords[i].CSS.indexOf("rowheader") > -1 ? "rows" : "";
                    break;
                }
            }
            return axis;
        ...
        _getAxis: function () {
            if ($(this.element).parents(".e-pivotclient").length > 0) {
                if (typeof (pivotGridObj) != "undefined" && this.element.hasClass("e-pivotgrid")) {
                    pivotGridObj = this;
                }
                if (this._pivotClientObj.model.operationalMode == ej.Pivot.OperationalMode.ClientMode)
                    this.setOlapReport($(this.element).parents(".e-pivotclient").data("ejPivotClient").model.dataSource);
            }
			if(this.getOlapReport())
			{
				var field = null,axis = "";
			...
			if (axis == "" && this.model.operationalMode == ej.PivotGrid.OperationalMode.ServerMode && this.model.analysisMode == ej.Pivot.AnalysisMode.Olap)
			    axis = this._getMDXAxis();
			return axis;
        },
        ...
        _applyFormatting: function () {
            this._isFormatApply = true;
            var format, formatName, json, index, st, val = [], axis, cdnTxt, fontcolor, bgcolor, bordercolor, borderrange, fStyle, fSize, borderstyle;
            var isValue = false;
            var fName = $("#" + this._id + '_editConText').val();
            if (!ej.isNullOrUndefined($("#" + this._id + '_conFrom').val())) {
                this._formatValue1 = $("#" + this._id + '_conFrom').val(), this._formatValue2 = $("#" + this._id + '_conTo').val(), cdnTxt = this.ddlConditionType._selectedValue, fontcolor = this.ddlFontColor.model.value, bgcolor = this.ddlBackColor.model.value, bordercolor = this.ddlBorderColor.model.value,
            ...
            this.renderControlFromJSON();
            if ($(this.element).parents(".e-pivotclient").length > 0)
                $(this.element).parents(".e-pivotclient").find(".e-dialog, .e-clientDialog").remove();
            this.element.find(".e-dialog, .e-clientDialog").remove();
            this._formatEdit = false;
        },
        ...
        _updateReportSettings: function (msg) {
            var JsonRecords = $.map(msg, function (obj, index) { var keyString = obj.Key; if (keyString == "JsonRecords" || keyString == "PivotRecords") return obj; });
            var report = $.map(msg, function (obj, index) { var keyString = obj.Key; if (keyString == "PivotReport" || keyString == "OlapReport") return obj; });
            var valueSorting = $.map(msg, function (obj, index) { var keyString = obj.Key; if (keyString == "SortColIndex") return obj; });
        ...
        _updatePageSettings: function (msg, pivotClientObj) {
            var pageSettings = $.map(msg, function (obj, index) { var keyString = obj.Key; if (keyString == "PageSettings") return obj; });
            var headerSettings = $.map(msg, function (obj, index) { var keyString = obj.Key; if (keyString == "HeaderCounts") return obj; });
        ...
        _removeCells: function (msg) {
            ...
            var message = [];
            if (msg[0] != undefined && msg.length > 0) {
                var colHeaders = $.map(msg, function (value) { var keyString = value.Key; if (keyString == "FilteredColumnHeaders") return value; });
                var rowHeaders = $.map(msg, function (value) { var keyString = value.Key; if (keyString == "FilteredRowHeaders") return value; });
                ...
                var colHeaders = $.map(msg.d, function (value) { var keyString = value.Key; if (keyString == "FilteredColumnHeaders") return value; });
                var rowHeaders = $.map(msg.d, function (value) { var keyString = value.Key; if (keyString == "FilteredRowHeaders") return value; });
                if (colHeaders.length > 0)
                    FilteredColumnHeaders = JSON.parse(colHeaders[0].Value);
                if (rowHeaders.length > 0)
                    FilteredRowHeaders = JSON.parse(rowHeaders[0].Value);
        ...
        _hideGrandTotal: function (tableGrid) {
            ...
            if (this.model.analysisMode == ej.Pivot.AnalysisMode.Pivot) {
                ...
                if ((tableGrid.find("tr:first th.summary").attr("data-p") != undefined || tableGrid.find(".pivotGridFrozenTable tr:first td.summary").attr("data-p") != undefined) && (!this.model.enableColumnGrandTotal || !this.model.enableGrandTotal) && this.model.analysisMode == ej.Pivot.AnalysisMode.Pivot) {
                    ...
                    for (var cLen = 0; cLen < calcGTTh.length; cLen++) {
                ...
                {
                    var isCheckSum = true, count = 0, gTotCells, rwLen;
                    if (this.model.operationalMode == ej.PivotGrid.OperationalMode.ServerMode || this.model.analysisMode == ej.Pivot.AnalysisMode.Olap) {
                        if (!this.model.enableColumnGrandTotal || !this.model.enableGrandTotal) {
                            ...
                            if (rwLen > 1 || (rwLen == 1 && $(tableGrid).find("th.summary[data-p$='," + count + "']").length > 0)) {
                                ...
                                for (var p = 0; p < gTotCells.length; p++) {
                                    ...
                                    var selectedCell = gTotCells[p]; var selectedCellPos = $(selectedCell).attr('data-p'), i = parseInt(selectedCellPos.split(',')[1]) - 1;
                        ...
                        if (!this.model.enableRowGrandTotal || !this.model.enableGrandTotal) {
                            ...
                            if (rwLen > 0) {
                                for (var p = 0; p < gTotCells.length; p++) {
                                    var cnt = count;
                                    var selectedCell = gTotCells[p]; var selectedCellPos = $(selectedCell).attr('data-p'), i = parseInt(selectedCellPos.split(',')[0]) - 1;
        ...
        _hideSubTotal: function (gridTable, targetLoop, target) {
            if (this.model.analysisMode == ej.Pivot.AnalysisMode.Pivot) {
            var rowHeader = {}, subRowVisible = false, colHeader = {}, subColVisible = false;
            ...
            var headerRowCaption = gridTable[0].querySelectorAll("tbody th.rowheader");
            var headerColCaption = gridTable[0].querySelectorAll("thead th, tbody td");
            for (var i = 0; i < rowData.length; i++) {
                if (rowData[i].showSubTotal == false) {
                    subRowVisible = true;
                }
            }
            if (subRowVisible == true) {
                for (var k = 0; k < headerRowCaption.length; k++) {
                    rowHeader[$(headerRowCaption[k]).attr("data-p")] = headerRowCaption[k];
                }
            }
            for (var i = 0; i < columnData.length; i++) {
                if (columnData[i].showSubTotal == false) {
            ...
            if (subColVisible == true) {
                for (var k = 0; k < headerColCaption.length; k++) {
                    colHeader[$(headerColCaption[k]).attr("data-p")] = headerColCaption[k];
                }
            }
          }
                ...
                if (this.model.operationalMode == ej.PivotGrid.OperationalMode.ClientMode) {
                    ...
                    for (var i = 0; i < axisItems.length; i++) {
                        ...
                        if (this.model.operationalMode == ej.PivotGrid.OperationalMode.ServerMode) {
                            ...
                            var filterIcon = axisItems[i].FieldHeader == "Measures" || axisItems[i].Tag == "Measures" || axisItems[i].Tag.indexOf("::NAMEDSET") > -1 ? "" : ej.buildTag("span.filter e-icon " + (axisItems[i].Filtered ? "filtered" : filtered)).attr("role", "button").attr("aria-label", "filter")[0].outerHTML;
        ...
        _createFields: function (tableOlapGrid, tableWidth, cellWidth) {
            ...
            if (ej.browserInfo().name.indexOf("moz") > -1) {
                this.element.find(".columns .e-btn, .e-rows .e-btn").addClass("e-pvtBtnIndent");
                this.element.find(".columns .e-sorting,.e-rows .e-sorting").addClass("e-pvtBtnSort");
            }
            ...
            if (this.element.find(".values").height() > 47) {
                ...
                if (this.element.find(".values .e-pivotButton").width() > this.element.find(".values").width() || (!this.model.enableDeferUpdate && this.element.find(".e-pivotGridTable").find("thead th:eq(1), tbody td.value:eq(0)").length == 0 && this.element.find(".values .e-pivotButton").length > 0)) {
            ...
            if (this.model.layout == "normal" && this.model.analysisMode == ej.Pivot.AnalysisMode.Olap && (((this.element.find(".values .e-pvtBtn").length == 0 || this.element.find(".columns .e-pvtBtn").length == 0) && (this.element.find(".e-rows").width() > this.element.find(".values").width() || this.element.find(".e-rows").width() > this.element.find(".columns").width()) && this.element.find(".emptyRows").width() == 140) || (this.model.enableDeferUpdate && (this.element.find(".values .e-pvtBtn").length <= 1 && this.element.find(".columns .e-pvtBtn").length <= 1)))) {
                var rowWidth = this.element.find(".e-rows").width();
                var valColumn = this.element.find(".values").width() + this.element.find(".columns").width();
                this.element.find(".values").css({ "min-width": rowWidth, "width": rowWidth });
                var valWidth = this.element.find(".values").width();
                this.element.find(".columns").css({ "min-width": valColumn - valWidth, "width": valColumn - valWidth });
                this.element.find(".columns .e-pvtBtn,.values .e-pvtBtn").width("auto").css({ "text-overflow": "ellipsis" });
                this.element.find(".emptyRows").width(rowWidth);
            }
            if (this.model.enableDeferUpdate && this.element.find(".columns .e-pivotButton").length != 0 && this.model.operationalMode == ej.PivotGrid.OperationalMode.ServerMode) {
                ...
                columnWidth = this.element.find('.e-pivotGridFrozenTable').width();
        ...
        _removePvtBtn: function (args) {
            ...
            if (this.model.operationalMode == ej.PivotGrid.OperationalMode.ClientMode) {
                ...
                var filterTag = "", filterItems = "", selectedElement = "", headerTag = "", uniqueName = "", report = "";
        ...
        renderControlFromJSON: function () {
            ...
            if (((jsonObj == null || jsonObj == "") && !this.model.enableGroupingBar)) {
                ...
                if (this.model.analysisMode == ej.Pivot.AnalysisMode.Olap) {
                    var rowLength = this._rowCount, isRowSubTotalHidden = false, JsonObj, rCount, isColumnSubTotalHidden = false, columnIndex, colSpan, row, rowIndex, removeElements, rowSpan, rowSpancount, colIndex, isRow = false, isColumn = false;
                    var jsonObject = $.extend(true, [], jsonObj);
                    var subTotalSettings = !ej.isNullOrUndefined(this._pivotClientObj) ? this._pivotClientObj.model.subTotalSettings : this.model.subTotalSettings;
                    var pivotRow = this.model.operationalMode == ej.Pivot.OperationalMode.ServerMode ? JSON.parse(this.getOlapReport()).PivotRows : this.model.dataSource.rows;
                    var pivotColumn = this.model.operationalMode == ej.Pivot.OperationalMode.ServerMode ? JSON.parse(this.getOlapReport()).PivotColumns : this.model.dataSource.columns;
                    if (!(ej.isNullOrUndefined(subTotalSettings))) {
                        for (var i = 0; i < subTotalSettings.length; i++) {
                            for (var j = 0; j < pivotRow.length; j++) {
                                if (subTotalSettings[i].name == (!ej.isNullOrUndefined(pivotRow[j].Tag) ? pivotRow[j].Tag : pivotRow[j].fieldName))
                                    isRow = true;
                            }
                            for (var j = 0; j < pivotColumn.length; j++) {
                                if (subTotalSettings[i].name == (!ej.isNullOrUndefined(pivotColumn[j].Tag) ? pivotColumn[j].Tag : pivotColumn[j].fieldName))
                                    isColumn = true;
                            }
                        }
                    }
                    var layout = !ej.isNullOrUndefined(this._pivotClientObj) ? this._pivotClientObj.gridLayout() : this.layout();
                    if (!(ej.isNullOrUndefined(subTotalSettings)) && isRow == true) {
                        var rowHeader = jsonObject.filter(function (index) {
                            return index.CSS == "rowheader" && index.RowSpan != 1 && index.State == 1;
                        });
                        if (rowHeader == 0) {
                            rowHeader = jsonObject.filter(function (index) {
                                return index.CSS == "rowheader" && index.RowSpan != 1;
                            });
                        }
                        for (var l = 0; l < subTotalSettings.length; l++) {
                            for (var i = 0; i < subTotalSettings[l].levels.length; i++) {
                                if (subTotalSettings[l].levels[i].showSubTotal == false && layout != "excellikelayout") {
                                    for (var j = 0; j < rowHeader.length; j++)
                                        if (subTotalSettings[l].levels[i].name == rowHeader[j].Info.split("::")[1]) {
                                            columnIndex = rowHeader[j].Index.split(",")[0];
                                            colSpan = rowHeader[j].ColSpan;
                                            row = rowHeader[j].Index.split(",")[1];
                                            for (var k = 0; k < jsonObject.length; k++) {
                                                if ((jsonObject[k].CSS == "summary" || jsonObject[k].CSS == "summary row") && jsonObject[k].Value == "Total" && !ej.isNullOrUndefined(jsonObject[k].Value) && !ej.isNullOrUndefined(jsonObject[k + 1]) && (jsonObject[k].Index.split(",")[0] == jsonObject[k + 1].Index.split(",")[0] || parseInt(jsonObject[k].Index.split(",")[0]) != 0) && jsonObject[k].Index.split(",")[0] == (parseInt(columnIndex) + colSpan).toString() && parseInt(row) <= parseInt(jsonObject[k].Index.split(",")[1])) {
                                                    isRowSubTotalHidden = true;
                                                    rowIndex = jsonObject[k].Index.split(",")[1];
                                                    removeElements = jsonObject[k];
                                                    rowSpan = jsonObject[k].RowSpan;
                                                    jsonObject.splice($.inArray(removeElements, jsonObject), 1);
                                                    ...
                                                    for (var z = 0; z < jsonObject.length; z++) {
                                                        if (jsonObject[z].Index.split(",")[1] == rowIndex) {
                                                            removeElements = jsonObject[z];
                                                            rowSpancount = rowSpan;
                                                            jsonObject.splice($.inArray(removeElements, jsonObject), 1);
                                                            if (rowSpancount > 1) {
                                                                while (rowSpancount != 1) {
                    ...
                    if (!(ej.isNullOrUndefined(subTotalSettings)) && isColumn == true) {
                        var columnHeader = jsonObject.filter(function (index) {
                            return index.CSS == "colheader" && index.ColSpan != 1 && index.State == 1;
                        });
                        if (columnHeader == 0) {
                            columnHeader = jsonObject.filter(function (index) {
                                return index.CSS == "colheader" && index.ColSpan != 1;
                            });
                        }
                        var grandTotalIndex = ((jsonObject.length / this._rowCount) - 1).toString();
                        for (var l = 0; l < subTotalSettings.length; l++) {
                            for (var i = 0; i < subTotalSettings[l].levels.length; i++) {
                                if (subTotalSettings[l].levels[i].showSubTotal == false && layout != "excellikelayout") {
                                    for (var j = 0; j < columnHeader.length; j++)
                                        if (subTotalSettings[l].levels[i].name == columnHeader[j].Info.split("::")[1]) {
                                            rowIndex = columnHeader[j].Index.split(",")[1];
                                            rowSpan = columnHeader[j].RowSpan;
                                            row = columnHeader[j].Index.split(",")[0];
                                            ColSpan = parseInt(columnHeader[j].ColSpan) - 1;
                                            for (var k = 0; k < jsonObject.length; k++) {
                                                if ((jsonObject[k].CSS == "summary" || jsonObject[k].CSS == "summary col") && (parseInt(jsonObject[k].Index.split(",")[0]) != grandTotalIndex || parseInt(jsonObject[k].Index.split(",")[1]) != 0) && parseInt(jsonObject[k].Index.split(",")[1]) == (parseInt(rowIndex) + rowSpan) && parseInt(jsonObject[k].Index.split(",")[0]) <= (parseInt(row) + ColSpan) && parseInt(row) <= parseInt(jsonObject[k].Index.split(",")[0])) {
                                                    isColumnSubTotalHidden = true;
                                                    columnIndex = jsonObject[k].Index.split(",")[0];
                                                    removeElements = jsonObject[k];
                                                    colSpan = jsonObject[k].ColSpan;
                                                    Index = k;
                                                    jsonObject.splice($.inArray(removeElements, jsonObject), 1);
                                                    for (var z = 0; z < jsonObject.length; z++) {
                                                        if (parseInt(columnIndex) <= parseInt(jsonObject[z].Index.split(",")[0]) && parseInt(jsonObject[z].Index.split(",")[0]) < parseInt(columnIndex) + colSpan) {
                                                            removeElements = jsonObject[z];
                                                            colSpancount = (colSpan - 1) * rowLength;
                                                            jsonObject.splice($.inArray(removeElements, jsonObject), 1);
                                                            z = z - 1;
                                                        }
                                                    }
                    ...
                    if (rowLength != this._rowCount && isRowSubTotalHidden == true) {
                        for (var idx = (jsonObject[0].RowSpan); idx < jsonObject.length; idx++) {
                            if ((jsonObject[idx].CSS == "rowheader" || jsonObject[idx].CSS == "summary" || jsonObject[idx].CSS == "summary row") && jsonObject[idx].RowSpan != 1) {
                                if (!ej.isNullOrUndefined(jsonObject[idx].State)) {
                                    rowIndex = jsonObject[idx].Index.split(',')[1];
                                    colIndex = jsonObject[idx].Index.split(',')[0];
                                    rowSpan = 0;
                                    for (j = 0; j < jsonObject[idx].RowSpan; j++) {
                                        if (((parseInt(rowIndex) + jsonObject[idx].RowSpan) > jsonObject[idx + j].Index.split(',')[1]) && colIndex == jsonObject[idx + j].Index.split(',')[0]) {
                                            rowSpan++;
                                        }
                                    }
                                    jsonObject[idx].RowSpan = rowSpan;
                                }
                            }
                        }
                    }
                    if (isColumnSubTotalHidden == true) {
                        for (var idx = 0; idx < jsonObject.length; idx++) {
                            if ((jsonObject[idx].CSS == "colheader" || jsonObject[idx].CSS == "summary" || jsonObject[idx].CSS == "summary col") && jsonObject[idx].ColSpan != 1) {
                                if (!ej.isNullOrUndefined(jsonObject[idx].State)) {
                                    rowIndex = jsonObject[idx].Index.split(',')[1];
                                    colIndex = jsonObject[idx].Index.split(',')[0];
                                    colSpan = 0;
                                    for (j = 0; j < jsonObject.length; j++) {
                                        if (idx + j < jsonObject.length && ((parseInt(colIndex) + jsonObject[idx].ColSpan) > parseInt(jsonObject[idx + j].Index.split(',')[0])) && rowIndex == jsonObject[idx + j].Index.split(',')[1]) {
                                            colSpan++;
                                            j += rowLength - 1;
                                        }
                                    }
                                    jsonObject[idx].ColSpan = colSpan;
                                }
                            }
                        }
                    }
                ...
                if (isRowSubTotalHidden == true || isColumnSubTotalHidden == true) {
                    JsonObj = jsonObject;
                    rCount = !ej.isNullOrUndefined(rowLength) ? rowLength : this._rowCount;
                    this._rowLength = !ej.isNullOrUndefined(rowLength) ? rowLength : this._rowCount;
                }
                else {
                    JsonObj = jsonObj;
                    rCount = this._rowCount;
                }
                        ...
                        if (istheadOlapGrid) {
                            ...
                            if (this.model.enableGroupingBar) {
                                if (JsonObj[index].Index == "0,0" && JsonObj[index].CSS.indexOf("colheader") > -1) {
                                    tRow = tRow + "<" + (isFrozenHeader ? "td" : "th") + " class='e-grpRow'" + " data-p='-1,-1' colspan= 1 rowspan=" + (rCount - 1) + "> <div class=e-rows>" + this._getLocalizedLabels("DragFieldHere") + "</div></th>";
                                    isNoRow = true;
                                }

                            }
                            for (var column = index; column < JsonObj.length; column = column + rCount) {
                                if (JsonObj[column].Span != "Block") {
                                    ...
                                    if (JsonObj[column].RowSpan > 1 && JsonObj[column].ColSpan <= 1) {
                                        ...
                                        for (var i = column + rCount; i < column + (JsonObj[column].ColSpan * rCount); i = i + rCount)
                                            if (!ej.isNullOrUndefined(JsonObj[i])) JsonObj[i].Span = "Block";
                                    }
                                    else if (JsonObj[column].ColSpan > 1 && JsonObj[column].RowSpan > 1) {
                                        for (var i = column; i < column + JsonObj[column].RowSpan; i++) {
                                            for (var j = i + rCount; j < i + (JsonObj[column].ColSpan * rCount); j = j + rCount)
                            ...
                            var tRow = "<tr role='row'>";
                            if (parseInt(JsonObj[index].Index.split(',')[0]) == 0 && parseInt(JsonObj[index].Index.split(',')[1]) == (rCount - 1) && isNoRow) {
            ...
            this._unWireEvents();
            this._wireEvents();
            var isClientPaging=false;
            if ((this._pivotClientObj)) {
                if (this._pivotClientObj.model.analysisMode == "olap" && this._pivotClientObj.model.operationalMode == "clientmode")
                    isClientPaging = (this._pivotClientObj.model.enableVirtualScrolling || this._pivotClientObj.model.enablePaging);
            }
            if ((!this.model.enableVirtualScrolling && !isClientPaging) && $(tableOlapGrid).find("tr:last > td").length > 0 && ($(tableOlapGrid).find("tr:last").find("td").text() == "" && $(tableOlapGrid).find("tr:last").hasClass("summary") && (!(this.model.operationalMode == ej.PivotGrid.OperationalMode.ClientMode && this.model.analysisMode == ej.Pivot.AnalysisMode.Pivot))) && (this._pagerObj == null))
            ...
            if (this.model.enableVirtualScrolling && ej.isNullOrUndefined(this._pivotClientObj)) {
            ...
            if (this._schemaData != null)
                this.element.find(".colheader, .rowheader, .value").addClass("e-droppable");
            this.exportRecords = (isRowSubTotalHidden == true || isColumnSubTotalHidden == true) ? JsonObj : jsonObj;
            ej.Pivot.closePreventPanel(this);
            if (this._schemaData)
            ...
            if (this.model.enableGroupingBar && this.element.find(".e-pivotGridTable").width() > 0) {
                ...
                if (this.model.enableColumnResizing) {
                    this.element.find(".groupingBarPivot").css({ "overflow": "hidden" });
                    if ((this.element.find(".e-pivotGridTable").width() + 1) == this.element.width())
                        this.element.find(".groupingBarPivot").css({ "width": "100%" });
                }
            }
            if (this.model.frozenHeaderSettings.enableFrozenHeaders || this.model.frozenHeaderSettings.enableFrozenColumnHeaders || this.model.frozenHeaderSettings.enableFrozenRowHeaders)
        ...
        _applyHeaders: function () {
            if (this._JSONRecords != null) {
                ...
                if (this.model.analysisMode != ej.PivotGrid.AnalysisMode.Olap && (this.model.headerSettings.showColumnItems || this.model.headerSettings.showRowItems) && !this.model.enableGroupingBar) {
                ...
                } else if (this.model.analysisMode == ej.PivotGrid.AnalysisMode.Olap && (this.model.headerSettings.showColumnItems || this.model.headerSettings.showRowItems) && this.model.layout != "excellikelayout" && !this.model.enableGroupingBar && ((mode && JSON.parse(this.getOlapReport()).PivotCalculations.length) || (!mode && this.model.dataSource.values[0].measures.length)) && (this._getAxis() == "columns" || this._getAxis() == "rows")) {
                    var index = 0,
                        measurePosition = -1;
                    ...
                    for (var i = 0; i < this._JSONRecords.length; i++) {
                        if (this._JSONRecords[i].CSS != "value" && this._JSONRecords[i].CSS != " value") {
                            if (this._JSONRecords[i].CSS == "rowheader" && this._JSONRecords[i].Info != "" && $.inArray($(".e-cubeTreeView").find("li[data-tag='" + this._JSONRecords[i].Info.split("::")[1] + "'] a:eq(0)").text(), row) == -1 && $.inArray(this._JSONRecords[i].Info.split("::")[1].replace(/[\[\]]+/g, ''), row) == -1 && this._JSONRecords[i].Info.indexOf('Measure') === -1) {
                                if ($(this.element).parents(".e-pivotclient").length > 0)
        ...
        _renderFrozenGridTable: function (tableOlapGrid, colHeader, tableBody) {
            var tRow1, frozenRowTable, frozenValTable, tbodyFrozenCol, tbodyFrozenRow, tbodyFrozenVal;
        ...
        _refreshScroller: function () {
            ...
            if (this.element.find(".pivotGridValueTable .value:visible").length > 0) {
                ...
                if (!this.model.frozenHeaderSettings.enableFrozenRowHeaders && this.model.frozenHeaderSettings.enableFrozenColumnHeaders) {
                    ...
                    this.element.find(".colfreeze").css({ "width": (this.element.find(".pivotGridRowTable").width()), float: (this.model.enableRTL ? "right" : "left") });
                    if (this.element.find(".pivotGridFrozenTable").height() > this.element.find(".colfreeze").height())
                    ...
                    if (this.model.enableGroupingBar) {
                        ...
                        if (this.element.find(".rowhead").width() < this.element.find(".colfreeze").width()) {
                            this.element.find(".colfreeze").width(this.element.find(".rowhead").width());
                            this.element.find(".columns").width("auto");
                        }
        ...
        _cellRangeInfo: function (e) {
            var pGridObj = $(e.target).parents(".e-pivotgrid").data("ejPivotGrid"), isPivotClient = (($(this.element).parents(".e-pivotclient").length > 0) || $(this.element).parents(".e-maximumView").length > 0);
            if (isPivotClient && this._pivotClientObj.model.enableDrillThrough && this.model.operationalMode == ej.Pivot.OperationalMode.ServerMode)
            ...
            var eventArgs = { selectedData: selectedCellsDetails ? selectedCellsDetails :[], element: this.element, customObject: this.model.customObject };
            ...
            if ((this.model.enableDrillThrough || isPivotClient && this._pivotClientObj.model.enableDrillThrough) && selectedCellsDetails.length > 0) {
                var control = isPivotClient && this._pivotClientObj.model.enableDrillThrough ? this._pivotClientObj : this;
        ...
        _completeCellEditing: function (e) {
            ...
            if (e.target.tagName != "INPUT") {
                    ...
                    if (this.model.analysisMode == ej.Pivot.AnalysisMode.Olap || $("#" + this._id).find("td[data-p*='," + rowSelCnt + "']").parent().is(":visible")) {
                        for (var colSelCnt = (parseInt(this._startCellPosition.split(",")[0]) < parseInt(endPosCell.split(",")[0]) ? parseInt(this._startCellPosition.split(",")[0]) : parseInt(endPosCell.split(",")[0])) ; colSelCnt <= (parseInt(this._startCellPosition.split(",")[0]) > parseInt(endPosCell.split(",")[0]) ? parseInt(this._startCellPosition.split(",")[0]) : parseInt(endPosCell.split(",")[0])) ; colSelCnt++) {
                            if (this.model.analysisMode == ej.Pivot.AnalysisMode.Olap || $("#" + this._id).find("[data-p*='" + colSelCnt + ",']").last("th").is(":Visible") || (!this.model.enableGrandTotal || !this.model.enableRowGrandTotal)) {
                                cellInfo[count] = this.getJSONRecords()[((colSelCnt) * this._rowCount) + rowSelCnt];
                                if (!this.element.find("[data-p=" + "'" + colSelCnt + ',' + rowSelCnt + "'" + "]").hasClass("summary")) {
                                    if (this.element.find("[data-p=" + "'" + colSelCnt + ',' + rowSelCnt + "'" + "] span.cellValue").length > 0) {
                                        var value = this.model.analysisMode == ej.Pivot.AnalysisMode.Olap ? (this.element.find("[data-p=" + "'" + colSelCnt + ',' + rowSelCnt + "'" + "] span.cellValue").text() != "" ? this.element.find("[data-p=" + "'" + colSelCnt + ',' + rowSelCnt + "'" + "] span.cellValue").text() : this.element.find(".curInput").val()) : this.element.find("[data-p=" + "'" + colSelCnt + ',' + rowSelCnt + "'" + "] span.cellValue").text();
                                        this.element.find("[data-p=" + "'" + colSelCnt + ',' + rowSelCnt + "'" + "] span.cellValue").html("<input type='text' class='curInput' value='" + value + "' />");
                                    }
                                    else if (this.element.find("[data-p=" + "'" + colSelCnt + ',' + rowSelCnt + "'" + "]").children().length > 0) {
                                        this.element.find("[data-p=" + "'" + colSelCnt + ',' + rowSelCnt + "'" + "]").append("<input type='text' class='curInput' value='' />");
                                    }
                                    else {
                                        var value = this.model.analysisMode == ej.Pivot.AnalysisMode.Olap ? (this.element.find("[data-p=" + "'" + colSelCnt + ',' + rowSelCnt + "'" + "]").text() != "" ? this.element.find("[data-p=" + "'" + colSelCnt + ',' + rowSelCnt + "'" + "]").text() : this.element.find(".curInput").val()) : this.element.find("[data-p=" + "'" + colSelCnt + ',' + rowSelCnt + "'" + "]").text();
                                        this.element.find("[data-p=" + "'" + colSelCnt + ',' + rowSelCnt + "'" + "]").html("<input type='text' class='curInput' value='" + value + "' />");
                                    }
                                }
                                var rowInfo, rowValue = "";
                                var tempThPos, measureColumn, measureRowCount = 0, measureColCount = 0;
                ...
                var args = { JSONRecords: cellInfo, rowHeader: this._rowHeader, columnHeader: this._colHeader, measureCount: (measureRowCount > 0 ? ("Row:" + measureRowCount) : ("Column:" + measureColCount)) }
                if (!ej.isNullOrUndefined(this._pivotClientObj))
                    this._pivotClientObj._trigger("cellSelection", args);
                else
                    this._trigger("cellSelection", args);
            ...
            this.element.find(".curInput").keypress(function (event) {
                if (event.which == 13) {
        ...
        _updateTableCell: function () {
            ...
            var editValue = this.element.find(".curInput");
            ...
            for (var i = tempVal.length - 1; i >= 0; i--) {
                if (tempVal[i] == this._originalValue.split("#")[i]) {
                    ...
                    if(!ej.isNullOrUndefined(this._cellInfo[i]))
                    this._cellInfo[i].Value = tempVal[i] = tempVal[i] == "" ? "" : tempVal[i];
                }
            }
            ...
            if (updateValue.length == 0) {
                for (var j = editValue.length - 1; j >= 0; j--) {
                    $(editValue[j]).closest("td").text(this.element.find(".curInput")[j].value)
                }
                return false;
            }
            this._waitingPopup.show();
            ...
            if (this.model.analysisMode == ej.Pivot.AnalysisMode.Pivot) {
                ...
                for (var uV = 0; uV < updateValueArray.length; uV++) {
                    var existCount = 0;
