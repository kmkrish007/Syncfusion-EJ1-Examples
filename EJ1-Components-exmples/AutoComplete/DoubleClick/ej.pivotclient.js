...
(function ($, ej, undefined) {
    ...
    ej.widget("ejPivotClient", "ej.PivotClient", {
        ...
        defaults: {
            ...
            sortCubeMeasures: ej.Pivot.SortOrder.Ascending,
            toolbarIconSettings: {
        ...
        _load: function () {
            ...
            if ((this.model.dataSource.data == null && this.model.url != "") || (this.model.operationalMode == ej.Pivot.OperationalMode.ServerMode)) {
                ...
                this.doAjaxPost("POST", this.model.url + "/" + this.model.serviceMethodSettings.initialize, JSON.stringify({
                    "action": (this.model.enableDrillThrough && this.model.operationalMode == ej.Pivot.OperationalMode.ServerMode && this.model.analysisMode == ej.Pivot.AnalysisMode.Pivot) ? "initializeClient:getDataSet" : "initializeClient", "customObject": serializedCustomObject, "clientParams": this.model.enableMeasureGroups + "-" + this.model.chartType + "-" + this.model.enableKPI + "-" + this.model.sortCubeMeasures + "-##-" + JSON.stringify(this.model.valueSortSettings)
        ...
        _createControl: function () {
            ...
            if (this.model.isResponsive) {
                ...
                this.model.enableRTL ? this._pivotSchemaDesigner.element.width(((this._pivotSchemaDesigner.element.width() - 37) / this._pivotSchemaDesigner.element.width() * 100) + "%") : this._pivotSchemaDesigner.element.width(((this._pivotSchemaDesigner.element.width() - 27) / this._pivotSchemaDesigner.element.width() * 100) + "%");
        ...
        refreshControl: function (report) {
            ...
            if (this.model.isResponsive && this.defaultView() == "chartonly") {
        ...
        _setModel: function (options) {
            for (var key in options) {
                switch (key) {
                    ...
                    case "sortCubeMeasures": this.model.sortCubeMeasures = options[key]; break;
        ...
        _wireEvents: function () {
            ...
            this.element.find(".e-categoricalAxis, .e-rowAxis, .e-slicerAxis").find("button").ejDraggable({
                ...
                dragStart: function (event, ui) {
                    var clientObj = this.element.parents(".e-pivotclient").data("ejPivotClient");
                    event.event.preventDefault();
                    $(this.element.find(".e-txt")).off('touchstart');
                    $(this.element.find(".e-txt")).off(ej.eventType.click);
                    clientObj.isDragging = true;
                    this.element.find(".e-dialog").hide();
                    clientObj.draggedSplitBtn = event.event.target;
                },
            ...
            if (!ej.isNullOrUndefined(this._pivotGrid) && this.model.enableDrillThrough) {
            ...
            this.element.find(".e-toggleCollapseButton").click(function (evt) {
                ...
                if (pivotClientObj.model.isResponsive) {
                    ...
                    var isOlapServer = pivotClientObj.model.operationalMode == ej.Pivot.OperationalMode.ServerMode && pivotClientObj.model.analysisMode == ej.Pivot.AnalysisMode.Olap;
                    ...
                    if (pivotClientObj.displayMode() == ej.PivotClient.DisplayMode.GridOnly && !isOlapServer)
                        pivotClientObj.element.find(".e-gridContainer").width(pivotClientObj.element.find(".e-controlPanel").width());
                    else if (pivotClientObj.displayMode() == ej.PivotClient.DisplayMode.GridOnly && isOlapServer)
                        pivotClientObj.element.find(".e-gridContainer").width(pivotClientObj.element.find(".e-controlPanel").width() - 2);
else if (pivotClientObj.displayMode() == ej.PivotClient.DisplayMode.ChartOnly)
                        pivotClientObj.element.find(".e-chartContainer").width(pivotClientObj.element.find(".e-controlPanel").width() - 6);
                        ...
                        if (pivotClientObj.defaultView() == ej.PivotClient.DefaultView.Grid) {
                            pivotClientObj.element.find(".e-gridContainer").width(pivotClientObj.element.find(".e-controlPanel").width() - 3);
                            pivotClientObj.element.find(".e-chartContainer").width(pivotClientObj.element.find(".e-controlPanel").width() - 8);
                        }
                        else {
                            pivotClientObj.element.find(".e-gridContainer").width(pivotClientObj.element.find(".e-controlPanel").width() - 3);
                            pivotClientObj.element.find(".e-chartContainer").width(pivotClientObj.element.find(".e-controlPanel").width() - 8);
                        ...
                        if (pivotClientObj.defaultView() == ej.PivotClient.DefaultView.Grid) {
                            pivotClientObj.element.find(".e-gridContainer").width(pivotClientObj.element.find(".e-controlPanel").width() - 2);
                            pivotClientObj.element.find(".e-chartContainer").width(pivotClientObj.element.find(".e-controlPanel").width() - 7);
                        }
                        else {
                            pivotClientObj.element.find(".e-gridContainer").width(pivotClientObj.element.find(".e-controlPanel").width() - 2);
                            pivotClientObj.element.find(".e-chartContainer").width(pivotClientObj.element.find(".e-controlPanel").width() - 7);
        ...
        _collapseCubeBrowser: function () {
            if (this.model.isResponsive)
                ...
                if (this._initToggle) {
                    ...
                    items["controlPanelWidth"] = !(this.displayMode() == ej.PivotClient.DisplayMode.ChartAndGrid) ? (tempWidth - ((this.model.collapseCubeBrowserByDefault && isOlapServer && this.controlPlacement() == ej.PivotClient.ControlPlacement.Tab ? 0 : 3))) + tolerance : (tempWidth - ((this.model.collapseCubeBrowserByDefault && isOlapServer && this.controlPlacement() == ej.PivotClient.ControlPlacement.Tab ? 0 : 5))) + tolerance;
                    items["chartOuterWidth"] = items["chartModelWidth"] = items["gridOuterWidth"] = tempWidth - (this.defaultView() == ej.PivotClient.DefaultView.Grid ? (24) : (-3));
                    this._toggleStyles.push(items);
                }
                if (this.displayMode() == ej.PivotClient.DisplayMode.GridOnly && !isOlapServer)
                    this.element.find(".e-gridContainer").width(this.element.width() - 30);
                else if (this.displayMode() == ej.PivotClient.DisplayMode.GridOnly && isOlapServer)
                    this.element.find(".e-gridContainer").width(this.element.width() - 39);
                else if (this.displayMode() == ej.PivotClient.DisplayMode.ChartOnly && !isOlapServer)
                    this.element.find(".e-chartContainer").width(this.element.width() - 36);
                else if (this.displayMode() == ej.PivotClient.DisplayMode.ChartOnly && isOlapServer)
                    this.element.find(".e-chartContainer").width(this.element.width() - 50);
                else if (this.controlPlacement() == ej.PivotClient.ControlPlacement.Tile) {
                    if (this.defaultView() == ej.PivotClient.DefaultView.Grid) {
                        var oServerDiff = isOlapServer ? 7 : 0;
                        this.element.find(".e-gridContainer").width(this.element.width() - (33 + oServerDiff));
                        this.element.find(".e-chartContainer").width(this.element.width() - (38 + oServerDiff));
                    }
                    else {
                        this.element.find(".e-gridContainer").width(this.element.width() - 33);
                        this.element.find(".e-chartContainer").width(this.element.width() - 38);
                    }
                }
                else if (this.controlPlacement() == ej.PivotClient.ControlPlacement.Tab) {
                    if (isOlapServer) {
                        this.element.find(".e-gridContainer").width(this.element.width() - 42);
                        this.element.find(".e-chartContainer").width(this.element.width() - 47);
                    }
                        ...
                        this.element.find(".e-gridContainer").width(this.element.width() - 32);
                        this.element.find(".e-chartContainer").width(this.element.width() - 37);
                   }
                }
        ...
        _wireDialogEvent: function () {
            ...
            this.element.find(".e-excelExportImg, .e-wordExportImg, .e-pdfExportImg").click(function (e) {
                var pivotClientObj = $(this).parents(".e-pivotclient").data("ejPivotClient");
                pivotClientObj.chartObj = pivotClientObj.element.find("#" + pivotClientObj._pivotChart._id + "Container").data("ejChart");
                if (pivotClientObj.displayMode() != ej.PivotClient.DisplayMode.GridOnly && !ej.isNullOrUndefined(pivotClientObj.chartObj) && pivotClientObj._currentTab === "grid" && pivotClientObj.model.isResponsive) {
                    pivotClientObj.element.find("#" + pivotClientObj._pivotChart._id + "Container").css("width",pivotClientObj.element.find("#" + pivotClientObj._pivotGrid._id).width());
                    pivotClientObj.chartObj.redraw();
                }
                ...
                var fileFormat = (exportOption == "Excel" ? pivotClientObj.model.operationalMode == ej.Pivot.OperationalMode.ServerMode ? ".xls" : ".xlsx" : exportOption == "Word" ? ".docx" : ".pdf");
                 var rowCnt = !ej.isNullOrUndefined(pivotClientObj._pivotGrid) ? (pivotClientObj._pivotGrid._excelLikeJSONRecords != null ? pivotClientObj._pivotGrid._excelRowCount : !ej.isNullOrUndefined(pivotClientObj._pivotGrid._rowLength) ? pivotClientObj._pivotGrid._rowLength : pivotClientObj._pivotGrid._rowCount) : 0, colCnt = !ej.isNullOrUndefined(pivotClientObj._pivotGrid) ? (pivotClientObj._pivotGrid._excelLikeJSONRecords != null ? Math.floor(pivotClientObj._pivotGrid._excelLikeJSONRecords.length / pivotClientObj._pivotGrid._excelRowCount) : pivotClientObj._pivotGrid.exportRecords != null && !ej.isNullOrUndefined(pivotClientObj._pivotGrid._rowLength) ? Math.floor(pivotClientObj._pivotGrid.exportRecords.length / pivotClientObj._pivotGrid._rowLength) : !ej.isNullOrUndefined(pivotClientObj._pivotGrid.getJSONRecords())) ?  Math.floor(pivotClientObj._pivotGrid.getJSONRecords().length / pivotClientObj._pivotGrid._rowCount) : 0 : 0;
                var reportName = pivotClientObj.element.find(".reportlist").data("ejDropDownList").getSelectedValue(), exportSetting = {}, chartExpObj = {};
                if (exportOption == "Excel")
                    exportSetting = { url: "", fileName: "PivotClient", exportMode: ej.PivotClient.ExportMode.JSON, title: reportName != null && reportName != "" ? reportName : "", description: "", exportChartAsImage: true, fileFormat: fileFormat, exportWithStyle: true, exportValueAsNumber: false, titleAlignment: "center" };
                else
                    exportSetting = { url: "", fileName: "PivotClient", exportMode: ej.PivotClient.ExportMode.JSON, title: reportName != null && reportName != "" ? reportName : "", description: "", fileFormat: fileFormat, exportWithStyle: true, titleAlignment: "center" };
                    ...
                    if (pivotClientObj.model.operationalMode == ej.Pivot.OperationalMode.ClientMode || (pivotClientObj._pivotGrid != null && pivotClientObj._pivotGrid._excelLikeJSONRecords != null && exportSetting.exportMode == ej.PivotClient.ExportMode.JSON) || ($.trim(exportSetting.url) != "" && exportSetting.exportMode == ej.PivotClient.ExportMode.JSON)) {
                        params = {
                            args: JSON.stringify({
                                ...
                                formatting: !ej.isNullOrUndefined(pivotClientObj._pivotGrid) && pivotClientObj._pivotGrid.model.enableConditionalFormatting ? pivotClientObj._pivotGrid._cFormat : (exportSetting.exportMode == ej.PivotClient.ExportMode.JSON ? [] : ''),
                    ...
                    if (evt.target.className.indexOf("e-loadReportImg") >= 0 || evt.target.className.indexOf("e-removeDBReportImg") >= 0 || evt.target.className.indexOf("e-renameDBReportImg") >= 0) {
                        ...
                        if (pivotClientObj.model.operationalMode == "servermode") {
                            ...
                            if (pivotClientObj.model.enableLocalStorage) {
                                pivotClientObj._fetchReportListSuccess({ d: [{ Name: "ReportNameList", Value: fetchReportSetting.reportList }, { Name: "Action", Value: action }] });
                            } else {
                                var serializedCustomObject = JSON.stringify(pivotClientObj.model.customObject);
            ...
            this.element.find(".e-dialogOKBtn").on(ej.eventType.click, function (e) {
                ...
                if (loadDlgTitle == pivotClientObj._getLocalizedLabels("Load")) {
                    ...
                    if (selectedReport != "") {
                        ...
                        pivotClientObj._measureSortOrder = pivotClientObj.model.sortCubeMeasures;
                        if (pivotClientObj.model.operationalMode == ej.Pivot.OperationalMode.ServerMode) {
                            if (pivotClientObj.model.beforeServiceInvoke != null)
                    ...
                    if (pivotClientObj._args_innerHTML != "ToolbarButtons") {
                        ...
                        if (pivotClientObj.element.find(".e-dialog:not(.e-calcMemberDialog, .e-calcMemberDialog .e-dialog) .e-titlebar").first().text() == pivotClientObj._getLocalizedLabels("RemoveReport") && pivotClientObj.reportsCount < 2)
                            ...
                            if ((operation == "Add Report" || operation == "New Report" || operation == "Remove Report") && pivotClientObj.model.operationalMode == ej.Pivot.OperationalMode.ServerMode) {
                                if (pivotClientObj.model.analysisMode == ej.Pivot.AnalysisMode.Pivot && pivotClientObj._pivotSchemaDesigner)
                                    pivotClientObj._pivotSchemaDesigner._tempFilterData = [];
            ...
            this.element.find(".e-calcMemberImg").click(function (evt) {
                ...
                if (pivotClientObj.element.find(".e-calcMemberDialog").length > 0) {
                    ...
                    if (pivotClientObj.model.operationalMode == ej.Pivot.OperationalMode.ServerMode) {
                        ...
                        var serializedCustomObject = JSON.stringify(pivotClientObj.model.customObject);
                        pivotClientObj.doAjaxPost("POST", pivotClientObj.model.url + "/" + pivotClientObj.model.serviceMethodSettings.fetchMemberTreeNodes, JSON.stringify({ "action": "fetchCalcMemberTreeView", "dimensionName": "calcMember" + ">#>" + pivotClientObj.model.sortCubeMeasures, "olapReport": pivotClientObj.currentReport, "customObject": serializedCustomObject }), ej.proxy(ej.Pivot._createCalcMemberDialog, pivotClientObj));
                    }
                    else {
                        var BlankNode = [];
        ...
        _updateReportCollection: function (isSaveRpt) {
            ...
            curRep = { "CubeName": cubeName, "CurrentReport": currentReport, "Reports": reports, "ReportIndex": reportList.selectedIndexValue, "ReportList": JSON.parse(JSON.stringify(reportList.model.dataSource)), _fieldSelectedMembers: this._fieldSelectedMembers, slicerBtnTextInfo: this._slicerBtnTextInfo, calculatedMembers: this.model.calculatedMembers, "measureSortOrder": this.model.sortCubeMeasures };
        ...
        _calculateHeight: function () {
            ...
            if (this.model.analysisMode == ej.Pivot.AnalysisMode.Olap && this.model.operationalMode == ej.Pivot.OperationalMode.ServerMode) {
                ...
                aebHeight = cdbHeight - ((this.element.find(".e-axisHeader").height() * 3) + (this.model.enableSplitter ? 8 : 5));
            ...
            this._chartHeight = this.model.enableToolBar ? containerHeight - 68 + "px" : ((this.model.isResponsive && this.controlPlacement() == ej.PivotClient.ControlPlacement.Tile && this.displayMode() == ej.PivotClient.DisplayMode.ChartAndGrid || this.displayMode() == ej.PivotClient.DisplayMode.ChartOnly) ? (this.model.analysisMode == ej.Pivot.AnalysisMode.Olap && this.model.operationalMode == ej.Pivot.OperationalMode.ServerMode ? ((containerHeight - 4) + "px") : ((containerHeight - 5) + "px")) : (containerHeight - 3) + "px");
        ...
        _rwdToggleExpand: function () {
            ...
            if (this.model.isResponsive && (this.displayMode() == "gridonly")) {
                $(".e-controlPanel").width(($("#" + this._id).width() * 55 / 100) + 15 + "px");
            }
            if (this.model.isResponsive && (this.displayMode() == "gridonly")) {
                this.element.find(".e-controlPanel").width(($("#" + this._id).width() * 55 / 100) + 15 + "px");
            }
            if (this.model.enableVirtualScrolling)
                this._pivotGrid._applyVScrolling();
            ...
            if (this.displayMode() != "gridonly") {
                if (this.controlPlacement() == ej.PivotClient.ControlPlacement.Tile && this.displayMode() == "chartandgrid") {
                    ...
                    $("#" + this._pivotChart._id).width($(".e-controlPanel").width() - 2);
                }
                this.chartObj = null;
                this.chartObj = this.element.find("#" + this._pivotChart._id + "Container").data("ejChart");
        ...
        _rwdToggleCollapse: function () {
            ...
            this.element.find(".controlPanelTD").css({ "left": (this.model.enableRTL ? "0" : "1%"), "right": (this.model.enableRTL ? "2%" : "0px"), "position": "relative", "width": "95%", "tableLayout": "auto", "float": "" });
            if (this.element.find(".e-gridContainer").length > 0)
                this.element.find(".e-gridContainer").css({ "width": this.controlPlacement() == ej.PivotClient.ControlPlacement.Tile && this._currentTab == "chart" ? "100%" : "99.8%" });
            if (this.displayMode() == "gridonly" && this.model.isResponsive)
                (this.model.analysisMode == ej.Pivot.AnalysisMode.Olap && this.model.operationalMode == ej.PivotGrid.OperationalMode.ServerMode) ? this.element.find(".e-controlPanel").css({ "width": $("#" + this._id).width() * 91 / 100 + 76 + "px" }) : this.element.find(".e-controlPanel").css({ "width": $("#" + this._id).width() * 91 / 100 + 76 + "px" });
            if (this.displayMode() == "chartonly" && this.model.isResponsive)
                (this.model.analysisMode == ej.Pivot.AnalysisMode.Olap && this.model.operationalMode == ej.PivotGrid.OperationalMode.ServerMode) ? this.element.find(".e-controlPanel").css({ "width": $("#" + this._id).width() * 91 / 100 + 87 + "px" }) : this.element.find(".e-controlPanel").css({ "width": $("#" + this._id).width() * 91 / 100 + 86 + "px" });
            $("#" + this._id).width("100%");
            ...
            if (this.displayMode() != "gridonly") {
                if (this.controlPlacement() == ej.PivotClient.ControlPlacement.Tile && this.displayMode() == "chartandgrid") {
                    ...
                    // if (!this.model.enableToolBar)
                    $("#" + this._pivotChart._id).width($(".e-controlPanel").width() - 26);
                    if (this.displayMode() == ej.PivotClient.DisplayMode.ChartOnly){
                ...
                if (this.displayMode() != ej.PivotClient.DisplayMode.GridOnly) {
                    ...
                    this.chartObj = this.element.find("#" + this._pivotChart._id + "Container").data("ejChart");
                    if (!ej.isNullOrUndefined(this.chartObj) && this.model.displaySettings.enableFullScreen) {
                        this.chartObj.model.size.width = this.element.find(".e-chartContainer").width() + "px" != "0px" ? this.element.find(".e-chartContainer").width() + "px" : this.element.find(".e-pivotchart").width() + "px";
                        this.chartObj.model.size.height = this.element.find(".e-chartContainer").height();
                        this.element.find("#" + this._pivotChart._id + "Container").width(this.chartObj.model.size.width );
                    }
                    if (ej.isNullOrUndefined(this.chartObj) && this.model.enablePivotTreeMap && !ej.isNullOrUndefined(this.otreemapObj))
        ...
        _maxViewBtnClick: function () {
            ...
            if (!ej.isNullOrUndefined(this._pivotChart)) {
                ...
                this._maxInitialChartWidth = this.element.find("#" + this._pivotChart._id + "Container").width() - 7;
        ...
        _maxViewClsBtnClick: function () {
            ...
            if (this.displayMode() == ej.PivotClient.DisplayMode.ChartOnly && ($("#" + this._pivotChart._id + "Container_svg")[0]))
                this._fullScreenViewCls(this._maxInitialChartHeight, (this._maxInitialChartWidth + (this.model.isResponsive? 7:0)));
            if (this.displayMode() == ej.PivotClient.DisplayMode.GridOnly)
                fullScreen.find("#" + this._id + "_PivotGrid").css({ "width": "inherit", "max-height": '', "overflow": "initial" });
            if (this.controlPlacement() == ej.PivotClient.ControlPlacement.Tab && this.displayMode() == "chartandgrid") {
        ...
        _calcMemberDroppedSuccess: function (data) {
            ...
            if (data[0] != undefined) {
                for (var i = 0; i < data.length; i++) {
                    ...
                    if (keyString == "calcMemberTreeData") {
        ...
        _calculateSize: function () {
            ...
            if (this.displayMode() != ej.PivotClient.DisplayMode.ChartOnly) {
                if (this.controlPlacement() == ej.PivotClient.ControlPlacement.Tile && this.displayMode() == ej.PivotClient.DisplayMode.ChartAndGrid) {
                    ...
                    if (this.defaultView() == ej.PivotClient.DefaultView.Grid) {
                        ...
                        this.element.find(".e-gridContainer").height((this.element.find(".e-controlPanel").height() / 2) - 10);
                        if (!this.model.isResponsive && !this.model.enableSplitter)
                            this.element.find(".e-gridContainer").width(this.element.find(".e-controlPanel").width() - ((this.enableTogglePanel() && this._currentTab == "chart") ? 15 : 16));
                    }
                }
                else {
                    if (this.displayMode() == ej.PivotClient.DisplayMode.GridOnly) {
                        this.element.find(".e-gridContainer").height(this.element.find(".e-controlPanel").height() - (this.model.operationalMode == ej.Pivot.OperationalMode.ClientMode ? 12 : 14));
                        if (!this.model.isResponsive && !this.model.enableSplitter)
                            this.element.find(".e-gridContainer").width(this.element.find(".e-controlPanel").width() - 15)
                    }
                    else {
            ...
            if (this.displayMode() != ej.PivotClient.DisplayMode.GridOnly) {
                if (this.controlPlacement() == ej.PivotClient.ControlPlacement.Tile && this.displayMode() == ej.PivotClient.DisplayMode.ChartAndGrid) {
                    ...
                    if (this.displayMode() == ej.PivotClient.DisplayMode.ChartOnly) {
                        this.element.find(".e-chartContainer").height(this.element.find(".e-controlPanel").height() - 22);
                        if (!this.model.isResponsive && !this.model.enableSplitter)
                            this.element.find(".e-chartContainer").width(this.element.find(".e-controlPanel").width() - 20);
                    }
                    else {
        ...
        refreshPagedPivotClientSuccess: function (msg) {
            var chartData = [];
            if (msg.d != undefined) {
                chartData = $.map(msg.d, function (ele, indx) { var keyString = ele.Key; if (keyString == "JsonRecords") return ele; });
                $.merge(chartData, $.map(msg.d, function (ele, indx) { var keyString = ele.Key; if (keyString == "OlapReport") return ele; }));
                this.reports = $.map(msg.d, function (ele, indx) { var keyString = ele.Key; if (keyString == "ClientReports") return ele.Value; }).toString();
            }
            else {
        ...
        _hiddenCellInfo: function (report) {
            var colHiddenCells = ($.map(report, function (item) { var keyString = item.Key; if (keyString == "FilteredColumnHeaders") return item.Value; }));
            var rowHiddenCells = ($.map(report, function (item) { var keyString = item.Key; if (keyString == "FilteredRowHeaders") return item.Value; }));
            ...
            if (msg[0] != undefined) {
                ...
                if (msg != "") {
                    if (!ej.isNullOrUndefined(msg.DataModel) && msg.DataModel != "Olap") {
                        ...
                        this._clientReportCollection = ej.isNullOrUndefined(msg.ReportCollection) ? [{ name: "Default", report: $.parseJSON(msg.PivotReport).Report, _fieldSelectedMembers: this._fieldSelectedMembers }] : JSON.parse(msg.ReportCollection);
        ...
        _toggleAxisSuccess: function (msg) {
            ...
            if (this.model.analysisMode == ej.Pivot.AnalysisMode.Pivot) {
                if (ej.isNullOrUndefined(msg.d))
                    ...
                    this.setOlapReport($.grep(msg.d, function (item) { var keyString = item.Key; return keyString == "PivotReport" })[0].Value);
        ...
        _cubeChangedSuccess: function (report) {
            ...
            !ej.isNullOrUndefined(report.Rows) ? $(this._createSplitButtons(report.Rows, "Rows")).appendTo(".e-rowAxis") : $(this._createSplitButtons("", "Rows")).appendTo(".e-rowAxis")
            !ej.isNullOrUndefined(report.Slicers) ? $(this._createSplitButtons(report.Slicers, "Slicers")).appendTo(".e-slicerAxis") : $(this._createSplitButtons("", "Slicers")).appendTo(".e-slicerAxis")
            this.element.find(".e-categoricalAxis, .e-rowAxis, .e-slicerAxis").find("button").ejButton({ height: "20px", type: ej.ButtonType.Button });
            this._setSplitBtnTitle();
            this._renderControls();
            this._unWireEvents();
        ...
        _toolbarOperationSuccess: function (report) {
            ...
            if (report != null) {
                ...
                else if (report.d != undefined && report.d[0] != undefined) {
                    keyString = report.d[0].Key; 
                    if (keyString == "CurrentAction" && report.d[0].Value != undefined && report.d[0].Value != "Load Report" && report.d[0].Value != "Add Report" && report.d[0].Value != "Remove Report" && report.d[0].Value != "New Report" && report.d[0].Value != "Rename Report" && report.d[0].Value != "Report Change") {
                ...
                if ((report.d != undefined && report.d || report[0] != undefined && report[0]) || report.CurrentReport || report.PivotReport) {
                    ...
                    if (report.length > 1 && report[0] != undefined) {
                        ...
                        if (this.model.enableMeasureGroups && report[12] != null && report[12] != undefined)
                            this.measureGroupInfo = $.parseJSON(report[12].Value);
                        if (report[13] != null && report[13] != undefined) {
                            var keyString = report[13].Key;
                            if (keyString != "Collection")
                                this.model.customObject = report[13].Value;
                        
                            else if (keyString == "Collection") {
                        ...
                        if (this.model.analysisMode == ej.Pivot.AnalysisMode.Pivot) {
                            action = $.grep(report.d, function (item) { var keyString = item.Key; return keyString == "CurrentAction" })[0].Value;
                            this.setOlapReport($.grep(report.d, function (item) { var keyString = item.Key; return keyString == "PivotReport" })[0].Value);
                            ...
                            if (action == "NewReport") {
                                ...
                                this.refreshControl({ GridJSON: JSON.stringify(""), ChartJSON: JSON.stringify(""), PivotReport: $.grep(report.d, function (item) { var keyString = item.Key; return keyString == "PivotReport" })[0].Value });
                            }
                                ...
                                this.refreshControl({
                                    GridJSON: $.grep(report.d, function (item) { var keyString = item.Key; return keyString == "GridJSON" })[0].Value,
                                    ChartJSON: $.grep(report.d, function (item) { var keyString = item.Key; return keyString == "ChartJSON" })[0].Value,
                                    PivotReport: $.grep(report.d, function (item) { var keyString = item.Key; return keyString == "PivotReport" })[0].Value,
                        ...
                        if (this.model.enableMeasureGroups && report.d[12] != null && report.d[12] != undefined)
                            this.measureGroupInfo = $.parseJSON(report.d[12].Value);
        ...
        _createSplitButtons: function (dimensionElements, axis) {
            ...
            if (dimensionElements.indexOf("~") > -1)
                ...
                for (var i = 0; i < dimensionElements.split('#').length - 1; i++) {
                    ...
                    splitButtons += ej.buildTag("div.e-splitBtn", ej.buildTag("button.e-pvtBtn", this.model.showUniqueNameOnPivotButton ? splitBtnTitle : caption).attr({ "title": splitBtnTitle, fieldCaption: caption, allMember: (!ej.isNullOrUndefined(dimensionElements.split('#')[i + 1].split("$")[1]) && (dimensionElements.split('#')[i + 1].split("$")[1]).toLowerCase().trim() == "multiple items") ? this._getLocalizedLabels("MultipleItems") : dimensionElements.split('#')[i + 1].split("$")[1] })[0].outerHTML + ej.buildTag("span.e-removeSplitBtn e-icon").attr("role", "button").attr("aria-label", "remove")[0].outerHTML, "", { "data-parenthierarchy": parent, "data-tag": axis + ':' + tag })[0].outerHTML;
                }
            return splitButtons;
        },
        ...
        _createDialogRequest: function (evt) {
            ...
            if ((evt.target.type == "button" && $(evt.target).parent().attr("data-tag").indexOf("::CalculatedMember") > -1)) {
                ...
                if (this.element.find(".calcMemberDialog").length > 0) {
                    ...
                    var serializedCustomObject = JSON.stringify(this.model.customObject);
                    this.doAjaxPost("POST", this.model.url + "/" + this.model.serviceMethodSettings.fetchMemberTreeNodes, JSON.stringify({ "action": "fetchCalcMemberTreeView", "dimensionName": "calcMember"+ ">#>" + this.model.sortCubeMeasures, "olapReport": this.currentReport, "customObject": serializedCustomObject }), ej.proxy(ej.Pivot._createCalcMemberDialog, this));
                }
                return;
            }
            if (this.model.enableMemberEditorPaging) {
        ...
        _createDialog: function (args_className, args_innerHTML, editorTree) {
            ...
            if (args_innerHTML === "Measures") {
                this.element.find(".e-memberEditorDiv").css({ "max-height": "286px", "overflow": "auto" });
            }
        ...
        _cubeChanged: function (sender) {
            ...
            var serializedCustomObject = JSON.stringify(this.model.customObject);
            this.doAjaxPost("POST", this.model.url + "/" + this.model.serviceMethodSettings.cubeChanged, JSON.stringify({ "action": "cubeChanged", "cubeName": this.currentCubeName, "olapReport": currentReport, "clientReports": reports, "customObject": serializedCustomObject, "clientParams": JSON.stringify(this.model.enableMeasureGroups) + "-" + this.model.enableKPI + "-" + this.model.sortCubeMeasures }), this._cubeChangedSuccess);
        },
        ...
        _reportChanged: function (sender) {
            ...
            else if (this._pivotSchemaDesigner && this.model.operationalMode == ej.Pivot.OperationalMode.ServerMode && this.model.analysisMode == ej.Pivot.AnalysisMode.Pivot) {
                this._pivotSchemaDesigner._tempFilterData = []
            }
            this.reportDropTarget = this.element.find('#reportList').data("ejDropDownList");
            if (this.model.operationalMode == ej.Pivot.OperationalMode.ClientMode) {
