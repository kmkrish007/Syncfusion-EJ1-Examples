...
MapLayerDirective.propDecorators = {
    ...
    'labelSettings_font': [{ type: core_2.Input, args: ['labelSettings.font',] },],
    'labelSettings_font_fontFamily': [{ type: core_2.Input, args: ['labelSettings.font.fontFamily',] },],
    'labelSettings_font_fontStyle': [{ type: core_2.Input, args: ['labelSettings.font.fontStyle',] },],
    'labelSettings_font_fontWeight': [{ type: core_2.Input, args: ['labelSettings.font.fontWeight',] },],
    'labelSettings_font_opacity': [{ type: core_2.Input, args: ['labelSettings.font.opacity',] },],
    'labelSettings_font_color': [{ type: core_2.Input, args: ['labelSettings.font.color',] },],
    'labelSettings_font_size': [{ type: core_2.Input, args: ['labelSettings.font.size',] },],
    ...
    'legendSettings_textPath': [{ type: core_2.Input, args: ['legendSettings.textPath',] },],
    ...
    'legendSettings_toggleVisibility': [{ type: core_2.Input, args: ['legendSettings.toggleVisibility',] },],
    ...
    'shapeSettings_colorPath': [{ type: core_2.Input, args: ['shapeSettings.colorPath',] },],
...
var MapComponent = (function (_super) {
    ...
    function MapComponent(el, cdRef, _ejIterableDiffers, _ejkeyvaluediffers) {
        ...
        _this.bubbleRendering_output = new core_2.EventEmitter();
        _this.shapeRendering_output = new core_2.EventEmitter();
        ...
        _this.onLoad_output = new core_2.EventEmitter();
        _this.markerEnter_output = new core_2.EventEmitter();
        _this.markerLeave_output = new core_2.EventEmitter();
...
MapComponent.propDecorators = {
    ...
    'zoomSettings_animationDuration_input': [{ type: core_2.Input, args: ['zoomSettings.animationDuration',] },],
    'zoomSettings_enableMouseWheelZoom_input': [{ type: core_2.Input, args: ['zoomSettings.enableMouseWheelZoom',] },],
    ...
    'bubbleRendering_output': [{ type: core_2.Output, args: ['bubbleRendering',] },],
    'shapeRendering_output': [{ type: core_2.Output, args: ['shapeRendering',] },],
    ...
    'onLoad_output': [{ type: core_2.Output, args: ['onLoad',] },],
    'markerEnter_output': [{ type: core_2.Output, args: ['markerEnter',] },],
    'markerLeave_output': [{ type: core_2.Output, args: ['markerLeave',] },],
