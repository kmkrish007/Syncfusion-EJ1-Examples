...
var PdfViewerComponent = (function (_super) {
    ...
    function PdfViewerComponent(el, cdRef, _ejIterableDiffers, _ejkeyvaluediffers) {
        ...
        _this.ajaxRequestSuccess_output = new core_2.EventEmitter();
        ...
        _this.downloadStart_output = new core_2.EventEmitter();
        _this.downloadEnd_output = new core_2.EventEmitter();
...
PdfViewerComponent.propDecorators = {
    ...
    'textSelectionContextMenu_input': [{ type: core_2.Input, args: ['textSelectionContextMenu',] },],
    'annotationContextMenu_input': [{ type: core_2.Input, args: ['annotationContextMenu',] },],
    ...
    'bufferingMode_input': [{ type: core_2.Input, args: ['bufferingMode',] },],
    ...
    'textSelectionContextMenu_isEnable_input': [{ type: core_2.Input, args: ['textSelectionContextMenu.isEnable',] },],
    'textSelectionContextMenu_isCopyEnable_input': [{ type: core_2.Input, args: ['textSelectionContextMenu.isCopyEnable',] },],
    'textSelectionContextMenu_isSearchEnable_input': [{ type: core_2.Input, args: ['textSelectionContextMenu.isSearchEnable',] },],
    'textSelectionContextMenu_isHighlightEnable_input': [{ type: core_2.Input, args: ['textSelectionContextMenu.isHighlightEnable',] },],
    'textSelectionContextMenu_isStrikeoutEnable_input': [{ type: core_2.Input, args: ['textSelectionContextMenu.isStrikeoutEnable',] },],
    'annotationContextMenu_isEnable_input': [{ type: core_2.Input, args: ['annotationContextMenu.isEnable',] },],
    'annotationContextMenu_isPopupEnable_input': [{ type: core_2.Input, args: ['annotationContextMenu.isPopupEnable',] },],
    'annotationContextMenu_isDeleteEnable_input': [{ type: core_2.Input, args: ['annotationContextMenu.isDeleteEnable',] },],
    'annotationContextMenu_isPropertiesEnable_input': [{ type: core_2.Input, args: ['annotationContextMenu.isPropertiesEnable',] },],
    ...
    'ajaxRequestSuccess_output': [{ type: core_2.Output, args: ['ajaxRequestSuccess',] },],
    ...
    'downloadStart_output': [{ type: core_2.Output, args: ['downloadStart',] },],
    'downloadEnd_output': [{ type: core_2.Output, args: ['downloadEnd',] },],
