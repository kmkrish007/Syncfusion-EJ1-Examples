...
export declare const CurrencyTextboxValueAccessor: any;
export declare class CurrencyTextboxComponent extends EJComponents<any, any> implements ControlValueAccessor {
    el: ElementRef;
...
export declare var EJ_CURRENCYTEXTBOX_COMPONENTS: Type<any>[];
