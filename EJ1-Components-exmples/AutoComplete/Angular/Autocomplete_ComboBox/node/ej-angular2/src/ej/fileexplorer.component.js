...
var FileExplorerComponent = (function (_super) {
    ...
    function FileExplorerComponent(el, cdRef, _ejIterableDiffers, _ejkeyvaluediffers) {
        ...
        _this.beforeUploadSend_output = new core_2.EventEmitter();
        ...
        _this.uploadComplete_output = new core_2.EventEmitter();
        _this.uploadError_output = new core_2.EventEmitter();
        _this.uploadSuccess_output = new core_2.EventEmitter();
        return _this;
    }
...
FileExplorerComponent.propDecorators = {
    ...
    'virtualItemCount_input': [{ type: core_2.Input, args: ['virtualItemCount',] },],
    ...
    'uploadSettings_dialogAction_input': [{ type: core_2.Input, args: ['uploadSettings.dialogAction',] },],
    'uploadSettings_dialogPosition_input': [{ type: core_2.Input, args: ['uploadSettings.dialogPosition',] },],
    'uploadSettings_maxFileSize_input': [{ type: core_2.Input, args: ['uploadSettings.maxFileSize',] },],
    'uploadSettings_showFileDetails_input': [{ type: core_2.Input, args: ['uploadSettings.showFileDetails',] },],
    ...
    'beforeUploadSend_output': [{ type: core_2.Output, args: ['beforeUploadSend',] },],
    ...
    'uploadComplete_output': [{ type: core_2.Output, args: ['uploadComplete',] },],
    'uploadError_output': [{ type: core_2.Output, args: ['uploadError',] },],
    'uploadSuccess_output': [{ type: core_2.Output, args: ['uploadSuccess',] },],
};
