...
TreeMapComponent.propDecorators = {
    ...
    'colorPath_input': [{ type: core_2.Input, args: ['colorPath',] },],
    ...
    'drillDownValue_input': [{ type: core_2.Input, args: ['drillDownValue',] },],
    'drillDownLevel_input': [{ type: core_2.Input, args: ['drillDownLevel',] },],
