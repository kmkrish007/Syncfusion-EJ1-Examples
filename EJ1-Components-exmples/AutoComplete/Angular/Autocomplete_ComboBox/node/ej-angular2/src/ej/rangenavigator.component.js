...
RangeNavigatorComponent.propDecorators = {
    ...
    'allowNextValue_input': [{ type: core_2.Input, args: ['allowNextValue',] },],
    ...
    'labelSettings_higherLevel_labelIntersectAction_input': [{ type: core_2.Input, args: ['labelSettings.higherLevel.labelIntersectAction',] },],
    ...
    'labelSettings_lowerLevel_labelIntersectAction_input': [{ type: core_2.Input, args: ['labelSettings.lowerLevel.labelIntersectAction',] },],
