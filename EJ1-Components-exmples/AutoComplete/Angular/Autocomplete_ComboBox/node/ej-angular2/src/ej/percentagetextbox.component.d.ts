...
export declare const PercentageTextboxValueAccessor: any;
export declare class PercentageTextboxComponent extends EJComponents<any, any> implements ControlValueAccessor {
    el: ElementRef;
...
export declare var EJ_PERCENTAGETEXTBOX_COMPONENTS: Type<any>[];
