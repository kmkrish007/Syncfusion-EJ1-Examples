...
DiagramConnectorLabelDirective.propDecorators = {
    ...
    'padding': [{ type: core_2.Input, args: ['padding',] },],
...
DiagramNodeDirective.propDecorators = {
    ...
    'borderGradient': [{ type: core_2.Input, args: ['borderGradient',] },],
...
DiagramComponent.propDecorators = {
    ...
    'layout_avoidSegmentOverlapping_input': [{ type: core_2.Input, args: ['layout.avoidSegmentOverlapping',] },],
