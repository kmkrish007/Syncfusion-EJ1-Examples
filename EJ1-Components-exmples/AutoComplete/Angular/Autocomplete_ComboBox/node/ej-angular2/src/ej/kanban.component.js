...
KanbanComponent.propDecorators = {
    ...
    'swimlaneSettings_showEmptySwimlane_input': [{ type: core_2.Input, args: ['swimlaneSettings.showEmptySwimlane',] },],
    ...
    'swimlaneSettings_headers_input': [{ type: core_2.Input, args: ['swimlaneSettings.headers',] },],
