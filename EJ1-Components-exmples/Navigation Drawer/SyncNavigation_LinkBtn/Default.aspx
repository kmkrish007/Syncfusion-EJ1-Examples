...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
        <div id="template1">
         <asp:LinkButton ID="Btn1" Text="Button" runat="server"></asp:LinkButton>
        <ej:Button Type="Button" runat="server" Text="Clic"></ej:Button>
    </div>
    <div class="row">
...
<p>
                    ...
                    <ej:NavigationDrawer runat="server" ID="navpane" Direction="Left" Type="Overlay" EnableListView="true" TargetId="butdrawer" ContentId="content_container">
                        <ListViewSettings Width="300" SelectedItemIndex="0" PersistSelection="true" MouseUp="headChange" RenderTemplate="true" TemplateId="template1" />
                        <Items>
