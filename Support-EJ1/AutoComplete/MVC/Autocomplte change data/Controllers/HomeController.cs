...
namespace Autocomplete.Controllers
{
    public class HomeController : Controller
    {
        ...
        {
            List<CarsList> cars1 = new List<CarsList>();
            cars1.Add(new CarsList { UniqueKey = 6, Text = "Bentley Mulsanne" });

            cars1.Add(new CarsList { UniqueKey = 7, Text = "Bugatti Veyron" });

            cars1.Add(new CarsList { UniqueKey = 8, Text = "Chevrolet Camaro" });

            cars1.Add(new CarsList { UniqueKey = 9, Text = "Cadillac" });

            cars1.Add(new CarsList { UniqueKey = 10, Text = "Duesenberg J " });

            cars1.Add(new CarsList { UniqueKey = 11, Text = "Dodge Sprinter" });
            cars1.Add(new CarsList { UniqueKey = 1, Text = "Audi S7" });

            cars1.Add(new CarsList { UniqueKey = 2, Text = "Austin-Healey" });

            cars1.Add(new CarsList { UniqueKey = 3, Text = "Alfa Romeo" });

            cars1.Add(new CarsList { UniqueKey = 4, Text = "Aston Martin" });
